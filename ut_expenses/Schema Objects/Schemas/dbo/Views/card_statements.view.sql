...
SELECT     dbo.card_statements_base.statementid, dbo.card_statements_base.name, dbo.card_statements_base.statementdate, dbo.card_statements_base.CreatedOn, 
                      dbo.card_statements_base.cardproviderid, [$(targetMetabase)].dbo.card_providers.cardprovider, dbo.card_statements_base.CreatedBy, 
                      dbo.card_statements_base.ModifiedOn, dbo.card_statements_base.ModifiedBy,
...
FROM         dbo.card_statements_base INNER JOIN
                      [$(targetMetabase)].dbo.card_providers ON [$(targetMetabase)].dbo.card_providers.cardproviderid = dbo.card_statements_base.cardproviderid
