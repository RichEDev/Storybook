...
BEGIN
	...
	SET @ApportionType = (SELECT [ApportionId] FROM [recharge_associations] WHERE [RechargeId] = @RA_Id)
	SET @Portion = (SELECT [Portion] FROM [recharge_associations] WHERE [RechargeId] = @RA_Id)
