...
begin
	...
	insert into reasons (reason, [description], accountcodevat, accountcodenovat, createdby, createdon, archived) values (@reason, @description, @accountcodevat, @accountcodenovat, @userid, @date, 0);
