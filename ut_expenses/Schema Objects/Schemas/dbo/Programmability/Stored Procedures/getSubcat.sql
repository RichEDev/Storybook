...
AS
 ...
 select 
  ...
  isRelocationMileage, reimbursableSubcatID, allowHeavyBulkyMileage, homeToOfficeAlwaysZero, StartDate, EndDate, Validate,
  HomeToOfficeFixedMiles, PublicTransportRate, EnableDutyOfCare,RequireClassOneBusinessInsurance
 from
  subcats
 where
  (
