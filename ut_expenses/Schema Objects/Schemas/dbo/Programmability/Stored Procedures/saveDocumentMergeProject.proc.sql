...
@CUemployeeID INT,
@CUdelegateID INT,
@defaultDocumentGroupingConfigId INT,
@blankTabletext nvarchar(100)
as
begin
               ...
               begin
                              ...
                              insert into document_mergeprojects (project_name, project_description, complete, createddate, createdby, modifieddate, modifiedby, DefaultDocumentGroupingConfigId, blankTableText)
                              values (@projectName, @projectDescription, 0, getdate(), @userId, getdate(), @userId, @defaultDocumentGroupingConfigId, @blankTableText)
               ...
               begin
                              ...
                              update document_mergeprojects set project_name = @projectName, project_description = @projectDescription, modifieddate = getdate(), modifiedby = @userId, DefaultDocumentGroupingConfigId = @defaultDocumentGroupingConfigId, blankTableText = @blankTableText
