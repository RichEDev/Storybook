...
SELECT DISTINCT addresses.[AddressID], addresses.[Postcode], [AddressName], addresses.[Line1], [Line2], [Line3], addresses.[City], [County], [Country], 
      [Archived], [CreationMethod], [LookupDate], [SubAccountID], [GlobalIdentifier], 
      [Longitude], [Latitude], addresses.[CreatedOn], addresses.[CreatedBy], addresses.[ModifiedOn], addresses.[ModifiedBy], [AccountWideFavourite]
FROM [dbo].[Addresses]
