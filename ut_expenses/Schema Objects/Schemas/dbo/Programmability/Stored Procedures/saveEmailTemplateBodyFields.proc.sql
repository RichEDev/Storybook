...
CREATE PROCEDURE [dbo].[saveEmailTemplateBodyFields] 
@emailtemplateid int,
...
BEGIN
	...
	set @recordTitle = (select @title1 + ' body field');

	insert into emailTemplateBodyFields (emailtemplateid, fieldid, emailfieldtype, joinViaId)
