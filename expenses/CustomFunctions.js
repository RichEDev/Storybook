...
var newsId = "subs";                   //name of the overall news div
var newsClipId = "subList";       //name of the news clipping div
...
function scrollIt(msg, dir,id,clipid) {
	newsId = id;
	newsClipId = clipid;
  window.status = msg; 
  mutex = dir;
