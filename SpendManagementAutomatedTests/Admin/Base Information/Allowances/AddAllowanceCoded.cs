...
namespace SpendManagement.AutomatedTests
{
    ...
    public class AddAllowanceCoded : WebTest
    {

        public AddAllowanceCoded()
        {
        ...
        public override IEnumerator<WebTestRequest> GetRequestEnumerator()
        {
            ...
            id = FindString.GetID(extracted, "=", "\"", 2);
            ...
            request7Body.BodyString = "{\"allowanceID\":0,\"name\":\"James Auto Test\",\"description\":\"Automatically generated " +
                "allowance - do not edit\",\"numhours\":10,\"rate\":20,\"currencyid\":" + id + "}";
            request7.Body = request7Body;
            yield return request7;
            request7 = null;

            WebTestRequest request8 = new WebTestRequest("https://www2.sel-expenses.com/expenses/admin/adminallowances.aspx");
            request8.ThinkTime = 5;
            yield return request8;
            request8 = null;

            WebTestRequest request9 = new WebTestRequest("https://www2.sel-expenses.com/expenses/admin/adminallowances.aspx");
