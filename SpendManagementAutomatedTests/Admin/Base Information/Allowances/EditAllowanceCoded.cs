...
namespace SpendManagement.AutomatedTests
{
    ...
    public class EditAllowanceCoded : WebTest
    {

        public EditAllowanceCoded()
        {
        ...
        public override IEnumerator<WebTestRequest> GetRequestEnumerator()
        {
            ...
            request7Body.BodyString = "{\"allowanceID\":" + id + ",\"name\":\"James Auto Test EDITED\",\"description\":\"Automatically ge" +
                "nerated allowance - EDITED\",\"numhours\":20,\"rate\":40,\"currencyid\":" + currencyid + "}";
