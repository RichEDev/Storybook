...
namespace SpendManagement.AutomatedTests
{
    ...
    public class DeleteLocationCoded : WebTest
    {

        public DeleteLocationCoded()
        {
        ...
        public override IEnumerator<WebTestRequest> GetRequestEnumerator()
        {
            ...
            request6.ExpectedResponseUrl = "https://www2.sel-expenses.com/shared/admin/adminlocations.aspx?name=james&";
            ...
            request6Body.FormPostParameters.Add("ctl00$contentmain$txtname", "james");
            ...
            WebTestRequest request7 = new WebTestRequest("https://www2.sel-expenses.com/shared/admin/adminlocations.aspx/deleteCompany");
            ...
            request8.QueryStringParameters.Add("name", "james", false, false);
