...
namespace SpendManagement.AutomatedTests
{
    ...
    using SpendManagement.AutomatedTests;


    public class DeleteDepartmentCoded : WebTest
    {

        public DeleteDepartmentCoded()
        {
        ...
        public override IEnumerator<WebTestRequest> GetRequestEnumerator()
        {
            ...
            WebTestRequest request5 = new WebTestRequest("https://www2.sel-expenses.com/categorymenu.aspx");
            request5.ThinkTime = 4;
            yield return request5;
            request5 = null;

            WebTestRequest request6 = new WebTestRequest("https://www2.sel-expenses.com/shared/admin/admindepartments.aspx");
            ...
            WebTestRequest request7 = new WebTestRequest("https://www2.sel-expenses.com/shared/admin/admindepartments.aspx/deleteDepartment" +
                    "");
            ...
            request7Body.BodyString = "{\"accountid\":239,\"departmentid\":" + id + "}";
            request7.Body = request7Body;
            yield return request7;
            request7 = null;

            WebTestRequest request8 = new WebTestRequest("https://www2.sel-expenses.com/shared/admin/admindepartments.aspx");
