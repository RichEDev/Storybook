...
namespace SpendManagement.AutomatedTests
{
    ...
    public class EditDepartmentCoded : WebTest
    {
        ...
        public override IEnumerator<WebTestRequest> GetRequestEnumerator()
        {
            ...
            request6.QueryStringParameters.Add("departmentid", id, false, false);
            ...
            request7.QueryStringParameters.Add("departmentid", id, false, false);
            ...
            request7Body.FormPostParameters.Add("ctl00$contentmain$txtdepartment", "James Auto Test EDITED");
