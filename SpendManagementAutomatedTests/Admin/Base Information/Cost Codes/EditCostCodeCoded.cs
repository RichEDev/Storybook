...
namespace SpendManagement.AutomatedTests
{
    ...
    public class EditCostCodeCoded : WebTest
    {

        public EditCostCodeCoded()
        {
        ...
        public override IEnumerator<WebTestRequest> GetRequestEnumerator()
        {
            ...
            WebTestRequest request5 = new WebTestRequest("https://www2.sel-expenses.com/shared/admin/admincostcodes.aspx");
            ...
            WebTestRequest request6 = new WebTestRequest("https://www2.sel-expenses.com/shared/admin/aecostcode.aspx");
            ...
            WebTestRequest request7 = new WebTestRequest("https://www2.sel-expenses.com/shared/admin/aecostcode.aspx");
            request7.ThinkTime = 3;
            request7.Method = "POST";
            request7.ExpectedResponseUrl = "https://www2.sel-expenses.com/shared/admin/admincostcodes.aspx";
            ...
            request7Body.FormPostParameters.Add("ctl00$contentmain$txtcostcode", "James Auto Test EDITED");
            ...
            WebTestRequest request8 = new WebTestRequest("https://www2.sel-expenses.com/shared/admin/admincostcodes.aspx");
