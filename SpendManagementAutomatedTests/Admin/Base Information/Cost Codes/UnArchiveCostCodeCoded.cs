...
namespace SpendManagement.AutomatedTests
{
    ...
    public class UnArchiveCostCodeCoded : WebTest
    {

        public UnArchiveCostCodeCoded()
        {
        ...
        public override IEnumerator<WebTestRequest> GetRequestEnumerator()
        {
            ...
            WebTestRequest request6 = new WebTestRequest("https://www2.sel-expenses.com/shared/admin/admincostcodes.aspx/changeStatus");
            ...
            request6Body.BodyString = "{\"accountid\":239,\"costcodeid\":" + id + "}";
            request6.Body = request6Body;
            yield return request6;
            request6 = null;

            WebTestRequest request7 = new WebTestRequest("https://www2.sel-expenses.com/shared/admin/admincostcodes.aspx");
