...
namespace SpendManagement.AutomatedTests
{
    ...
    public class DeleteCostCodeCoded : WebTest
    {

        public DeleteCostCodeCoded()
        {
        ...
        public override IEnumerator<WebTestRequest> GetRequestEnumerator()
        {
            ...
            WebTestRequest request6 = new WebTestRequest("https://www2.sel-expenses.com/shared/admin/admincostcodes.aspx/deleteCostcode");
