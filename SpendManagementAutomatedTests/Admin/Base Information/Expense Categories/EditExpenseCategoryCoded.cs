...
namespace SpendManagement.AutomatedTests
{
    ...
    public class EditExpenseCategoryCoded : WebTest
    {

        public EditExpenseCategoryCoded()
        {
        ...
        public override IEnumerator<WebTestRequest> GetRequestEnumerator()
        {
            ...
            WebTestRequest request5 = new WebTestRequest("https://www2.sel-expenses.com/admin/admincategories.aspx");
            ...
            WebTestRequest request6 = new WebTestRequest("https://www2.sel-expenses.com/admin/aecategory.aspx");
            request6.ThinkTime = 8;
            request6.QueryStringParameters.Add("action", "2", false, false);
            request6.QueryStringParameters.Add("categoryid", id, false, false);
            ...
            WebTestRequest request7 = new WebTestRequest("https://www2.sel-expenses.com/admin/aecategory.aspx");
            request7.ThinkTime = 2;
            request7.Method = "POST";
            request7.ExpectedResponseUrl = "https://www2.sel-expenses.com/admin/admincategories.aspx";
            request7.QueryStringParameters.Add("action", "2", false, false);
            request7.QueryStringParameters.Add("categoryid", id, false, false);
            ...
            request7Body.FormPostParameters.Add("ctl00$contentmain$txtcategory", "James Auto Test EDITED");
            ...
            WebTestRequest request8 = new WebTestRequest("https://www2.sel-expenses.com/admin/admincategories.aspx");
            if ((this.Context.ValidationLevel >= Microsoft.VisualStudio.TestTools.WebTesting.ValidationLevel.High))
            {
                ValidationRuleFindText validationRule2 = new ValidationRuleFindText();
                validationRule2.FindText = "James Auto Test EDITED";
