...
namespace SpendManagement.AutomatedTests
{
    ...
    public class DeleteExpenseCategoryCoded : WebTest
    {

        public DeleteExpenseCategoryCoded()
        {
        ...
        public override IEnumerator<WebTestRequest> GetRequestEnumerator()
        {
            ...
            WebTestRequest request6 = new WebTestRequest("https://www2.sel-expenses.com/admin/admincategories.aspx/deleteCategory");
            ...
            request6Body.BodyString = "{\"accountid\":239,\"categoryid\":" + id + "}";
            request6.Body = request6Body;
            yield return request6;
            request6 = null;

            WebTestRequest request7 = new WebTestRequest("https://www2.sel-expenses.com/admin/admincategories.aspx");
