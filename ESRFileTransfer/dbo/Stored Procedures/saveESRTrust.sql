...
AS 
      ...
      IF (@trustID = 0)
            BEGIN
                  ...
                  INSERT INTO esrTrusts (trustName, trustVPD, periodType, periodRun, ftpAddress, ftpUsername, ftpPassword, createdOn, runSequenceNumber, delimiterCharacter, ESRVersionNumber) VALUES (@trustName, @trustVPD, @periodType, @periodRun, @ftpAddress, @ftpUsername, @ftpPassword, getutcdate(), @runSequenceNumber, @delimiterCharacter, @esrTrustVersionNumber);
