namespace DutyOfCareAPI.DutyOfCare
{
    ...
    public interface IDutyOfCareApi 
    {
        ...
        /// The registration of the vehicle to look up
        /// </param>
        /// <param name="lookupLogger">
        /// An instance of <see cref="ILookupLogger"/>
        /// </param>
        /// <param name="invalidVateVehicleDocuments">
        /// Whether vehicle document statuses are invalid after lookup
        /// </param>
        /// <returns>
        /// An instance of <see cref="IVehicleLookupResult"/>
        /// </returns>
        IVehicleLookupResult Lookup(string registrationNumber, ILookupLogger lookupLogger, bool invalidVateVehicleDocuments);
    }
}
