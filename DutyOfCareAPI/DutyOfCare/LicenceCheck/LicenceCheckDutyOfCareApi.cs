namespace DutyOfCareAPI.DutyOfCare.LicenceCheck
{
    ...
    public class LicenceCheckDutyOfCareApi : IDutyOfCareApi
    {
        ...
        /// </param>
        /// <param name="createVehicleDocuments">
        /// Whether vehicle documents are created on lookup
        /// </param>
        /// <returns>
        /// An instance of <see cref="IVehicleLookupResult"/>
        /// </returns>
        public IVehicleLookupResult Lookup(string registrationNumber, ILookupLogger lookupLogger, bool createVehicleDocuments)
        {
            return this.VehicleLookup.Lookup(registrationNumber, lookupLogger, createVehicleDocuments);
        }
