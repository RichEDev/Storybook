namespace UnitTest2012Ultimate.Library
{
    ...
    /// <summary>
    /// Unit tests for "Deduct Home to Office Distance if journey starts or finishes at home"
    /// </summary>
    [TestClass]
    public class JourneyDeductionHomeToOfficeIfStartOrFinishHomeTest
    {
        #region Fields
        ...
        /// No deductions here
        /// </summary>
        [TestMethod, TestCategory("Spend Management Library"), TestCategory("Journey Deduction Rules - Home To Office If Start Or Finish Home")]
        public void DeductWhereNoHomeAddressInJourney()
        {
            ...
            var rule = new HomeToOfficeIfStartOrFinishHome(steps, HomeToOfficeDistance, OfficeToHomeDistance, HomeLocationId, OfficeLocationId, new cSubcat());
        ...
        public void DeductWhereHomeAddressInMiddleOfJourney()
        {
            ...
            var rule = new HomeToOfficeIfStartOrFinishHome(steps, HomeToOfficeDistance, OfficeToHomeDistance,
                HomeLocationId, OfficeLocationId, new cSubcat());
            var deductedSteps = rule.Deduct();
