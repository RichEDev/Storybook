namespace UnitTest2012Ultimate.Library
{
    ...
    /// </summary>
    [TestClass]
    public class JourneyDeductionFullHomeToOfficeForEveryHomeVisitTest
    {
        #region Fields
        ...
        /// </summary>
        private const decimal OfficeToHomeDistance = 9.37m;
        ...
        /// No deductions here
        /// </summary>
        [TestMethod, TestCategory("Spend Management Library"), TestCategory("Journey Deduction Rules - Deduct Full Home To Office Every Time Home is Visited")]
        public void DeductWhereNoHomeAddressInJourney()
        {
            ...
            var rule = new FullHomeToOfficeForEveryHomeVisit(steps, HomeToOfficeDistance, OfficeToHomeDistance, HomeLocationId, OfficeLocationId, new cSubcat());
