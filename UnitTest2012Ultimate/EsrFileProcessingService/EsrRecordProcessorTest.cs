namespace UnitTest2012Ultimate.EsrNhsHubFileTransferService
{
    ...
    /// <summary>
    ///     The Transfers test.
    ///     Should match the tests in EsrNhsHubFileTransferService TransfersTest
    /// </summary>
    [TestClass]
    public class EsrRecordProcessorTest
    {
        /// <summary>
...
// ReSharper disable InconsistentNaming
        ...
        public void EsrRecordProcessor_ValidateFileTransfer_NullBytes()
        {
            byte[] bytes = null;
            string returnMessage;
            List<string> rows = null;

            EsrRecordProcessor.ValidateFileTransfer(ref rows, out returnMessage);
        }
        ...
        /// </summary>
        [TestCategory("Spend Management"), TestCategory("ESRv2"), TestMethod]
        public void EsrRecordProcessor_ValidateFileTransfer_NoBytes()
        {
            byte[] bytes = new byte[0];
            string returnMessage;
            List<string> rows = Encoding.ASCII.GetString(bytes).Split('\n').ToList();

            bool actual = EsrRecordProcessor.ValidateFileTransfer(ref rows, out returnMessage);
        ...
        /// </summary>
        [TestCategory("Spend Management"), TestCategory("ESRv2"), TestMethod]
        public void EsrRecordProcessor_ValidateFileTransfer_TwoRowsWhitespaceFile()
        {
            /*
             * _
             * _
        ...
        /// </summary>
        [TestCategory("Spend Management"), TestCategory("ESRv2"), TestMethod]
        public void EsrRecordProcessor_ValidateFileTransfer_NotEnoughCharacters()
        {
            /*
             * 
             * 
        ...
        /// </summary>
        [TestCategory("Spend Management"), TestCategory("ESRv2"), TestMethod]
        public void EsrRecordProcessor_ValidateFileTransfer_InvalidDelimeter()
        {
            /*
             * HDR-GOBlahBlah-01
        ...
        /// </summary>
        [TestCategory("Spend Management"), TestCategory("ESRv2"), TestMethod]
        public void EsrRecordProcessor_ValidateFileTransfer_MultipleRowsWhitespaceFile()
        {
            /*
             * _
             * _
             ...
             * _
             */
            byte[] bytes = new byte[] { 0x20, 0x0A, 0x20, 0x0A, 0x20, 0x0A, 0x20, 0x0A, 0x20 };
            string returnMessage;
            List<string> rows = Encoding.ASCII.GetString(bytes).Split('\n').ToList();
        ...
        /// </summary>
        [TestCategory("Spend Management"), TestCategory("ESRv2"), TestMethod]
        public void EsrRecordProcessor_ValidateFileTransfer_InvalidHeaderH()
        {
            /*
             * GDR~GOBlahBlah~01
             * Some~Entries~In~The~Row
        ...
        /// </summary>
        [TestCategory("Spend Management"), TestCategory("ESRv2"), TestMethod]
        public void EsrRecordProcessor_ValidateFileTransfer_InvalidHeaderD()
        {
            /*
             * HCR~GOBlahBlah~01
             * Some~Entries~In~The~Row
        ...
        /// </summary>
        [TestCategory("Spend Management"), TestCategory("ESRv2"), TestMethod]
        public void EsrRecordProcessor_ValidateFileTransfer_InvalidHeaderR()
        {
            /*
             * HDQ~GOBlahBlah~01
             * Some~Entries~In~The~Row
        ...
        /// </summary>
        [TestCategory("Spend Management"), TestCategory("ESRv2"), TestMethod]
        public void EsrRecordProcessor_ValidateFileTransfer_InvalidFooterT()
        {
            /*
             * HDR~GOBlahBlah~01
             * Some~Entries~In~The~Row
        ...
        /// </summary>
        [TestCategory("Spend Management"), TestCategory("ESRv2"), TestMethod]
        public void EsrRecordProcessor_ValidateFileTransfer_InvalidFooterR()
        {
            /*
             * HDR~GOBlahBlah~01
             * Some~Entries~In~The~Row
        ...
        /// </summary>
        [TestCategory("Spend Management"), TestCategory("ESRv2"), TestMethod]
        public void EsrRecordProcessor_ValidateFileTransfer_InvalidFooterL()
        {
            /*
             * HDR~GOBlahBlah~01
             * Some~Entries~In~The~Row
        ...
        /// </summary>
        [TestCategory("Spend Management"), TestCategory("ESRv2"), TestMethod]
        public void EsrRecordProcessor_ValidateFileTransfer_MissingRowCount()
        {
            /*
             * HDR~GOBlahBlah~01
             * Some~Entries~In~The~Row
        ...
        /// </summary>
        [TestCategory("Spend Management"), TestCategory("ESRv2"), TestMethod]
        public void EsrRecordProcessor_ValidateFileTransfer_InvalidRowCount()
        {
            /*
             * HDR~GOBlahBlah~01
             * Some~Entries~In~The~Row
        ...
        /// </summary>
        [TestCategory("Spend Management"), TestCategory("ESRv2"), TestMethod]
        public void EsrRecordProcessor_ValidateFileTransfer_IncorrectRowCount()
        {
            /*
             * HDR~GOBlahBlah~01
             * Some~Entries~In~The~Row
        ...
        /// </summary>
        [TestCategory("Spend Management"), TestCategory("ESRv2"), TestMethod]
        public void EsrRecordProcessor_ValidateFileTransfer_ValidFileWithTrailingWhiteSpace()
        {
            /*
             * HDR~GOBlahBlah~01
             * Some~Entries~In~The~Row
        ...
        /// </summary>
        [TestCategory("Spend Management"), TestCategory("ESRv2"), TestMethod]
        public void EsrRecordProcessor_ValidateFileTransfer_ValidFileWithTrailingLine()
        {
            /*
             * HDR~GOBlahBlah~01
             * Some~Entries~In~The~Row
        ...
        /// </summary>
        [TestCategory("Spend Management"), TestCategory("ESRv2"), TestMethod]
        public void EsrRecordProcessor_ValidateFileTransfer_ValidFileWithTrailingLineAndWhiteSpace()
        {
            /*
             * HDR~GOBlahBlah~01
             * Some~Entries~In~The~Row
        ...
        /// </summary>
        [TestCategory("Spend Management"), TestCategory("ESRv2"), TestMethod]
        public void EsrRecordProcessor_ValidateFileTransfer_ValidFile()
        {
            /*
             * HDR~GOBlahBlah~01
             * Some~Entries~In~The~Row
