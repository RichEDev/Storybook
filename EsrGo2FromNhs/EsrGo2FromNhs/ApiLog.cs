namespace EsrGo2FromNhs
{
    ...
    using LogDbConnection = global::EsrGo2FromNhs.Crud.LogDbConnection;
    using Logger = global::EsrGo2FromNhs.Crud.Logger;
    ...
    public class ApiLog : IApiLog
    {
        ...
        /// </summary>
        /// <returns>
        /// The <see cref="ApiLog.ApiLog.MessageLevel"/>.
        /// </returns>
        public MessageLevel GetLoggingLevel()
        {
            ...
            return (MessageLevel)this.connection.DebugLevel;
        }
    }
}
