namespace EsrGo2FromNhs.Base
{
    ...
    public static class Logger
    {
        ...
        /// </param>
        /// <returns>
        /// The <see cref="EsrGo2FromNhs.Base.Log.MessageLevel"/>.
        /// </returns>
        public static global::EsrGo2FromNhs.Base.Log.MessageLevel GetMessageLevel(IApiDbConnection expdata = null)
        {
            if (expdata == null)
            {
                using (expdata = new global::EsrGo2FromNhs.Base.LogDbConnection())
                {
