namespace EsrGo2FromNhs
{
    ...
    using global::EsrGo2FromNhs.Interfaces;

    using Action = global::EsrGo2FromNhs.Base.Action;
    using ApiResult = global::EsrGo2FromNhs.Base.ApiResult;
    using EsrAddressRecord = global::EsrGo2FromNhs.ESR.EsrAddressRecord;
    using EsrAssignmentCostingRecord = global::EsrGo2FromNhs.ESR.EsrAssignmentCostingRecord;
    using EsrAssignmentRecord = global::EsrGo2FromNhs.ESR.EsrAssignmentRecord;
    ...
    using EsrPhoneRecord = global::EsrGo2FromNhs.ESR.EsrPhoneRecord;
    using EsrPositionRecord = global::EsrGo2FromNhs.ESR.EsrPositionRecord;
    using EsrVehicleRecord = global::EsrGo2FromNhs.ESR.EsrVehicleRecord;
    ...
    public class ApiRpc : IApiRpc
    {
        ...
        public EsrTrust GetAccountFromVpd(string vpd)
        {
            ...
            this._logger.WriteDebug(string.Empty, vpdId, 0, LogRecord.LogItemTypes.None, LogRecord.TransferTypes.EsrOutbound, 0, string.Empty, LogRecord.LogReasonType.None, string.Format("{0} - {1}", "GetAccountFromVpd", DateTime.Now), "ApiRpc");
            var esrTrusts = new EsrTrustCrud(this._metaBase, 0, this._esrApiHandler, this._logger)
                            {
                                TrustVpd = vpdId.ToString(CultureInfo.InvariantCulture)
                            };
