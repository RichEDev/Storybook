namespace EsrGo2FromNhs.ESR
{
    ...
    public class EsrPersonRecord : EsrPerson
    {
        ...
        public static EsrPersonRecord ParseEsrPersonRecord(string recordLine)
        {
            ...
            if (rec.Length != ((int)PersonRecordColumnsRef.Spare7 + 1) && rec.Length != EsrFile.RecordDeleteLength)
            {
        ...
        public void AddAssignmentCostingRecord(global::EsrGo2FromNhs.ESR.EsrAssignmentCostingRecord rec)
        {
