...
if @templateID = 0
BEGIN
	INSERT INTO importTemplates (templateName, applicationType, isAutomated, NHSTrustID, createdOn, createdBy) VALUES (@templateName, @applicationType, @isAutomated, @NHSTrustID, @date, @userid)
...
BEGIN
	...
	UPDATE importTemplates SET templateName = @templateName, applicationType = @applicationType, isAutomated = @isAutomated, NHSTrustID = @NHSTrustID, modifiedOn = @date, modifiedBy = @userid WHERE templateID = @templateID;
