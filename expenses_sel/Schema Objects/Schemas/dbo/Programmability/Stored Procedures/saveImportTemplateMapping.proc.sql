...
BEGIN
	...
	INSERT INTO importTemplateMappings (templateID, fieldID, destinationField, columnRef, importElementType, mandatory, dataType) VALUES (@templateID, @fieldID, @destinationField, @columnRef, @importElementType, @mandatory, @dataType)
