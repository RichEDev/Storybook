<%@ Page MasterPageFile="~/FWMaster.master" Language="vb" AutoEventWireup="false" Inherits="Framework2006.VerifyAttachments" CodeFile="VerifyAttachments.aspx.vb" %>
...
<asp:Content ID="Content3" runat="server" ContentPlaceHolderID="contentmain">
    ...
    <div class="inputpanel">
        ...
        <asp:ImageButton runat="server" ID="cmdCancel" ImageUrl="./buttons/page_close.gif" CausesValidation="false" />
    </div>
</asp:Content>
<asp:Content ID="Content4" runat="server" contentplaceholderid="contentmenu">
<a href="./help_text/default_csh.htm#1188" target="_blank" class="submenuitem">Help</a>                
</asp:Content>
