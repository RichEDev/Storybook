<%@ Page Language="VB" MasterPageFile="~/FWMaster.master" AutoEventWireup="false"
    CodeFile="FWParams.aspx.vb" Inherits="Framework2006.FWParams" Title="Framework Parameters" %>

<%@ MasterType VirtualPath="~/FWMaster.master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="contentmenu" runat="Server">
    <a href="./help_text/default_csh.htm#1141" target="_blank" class="submenuitem">Help</a>
</asp:Content>
