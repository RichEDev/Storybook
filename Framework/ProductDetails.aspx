<%@ Page MasterPageFile="~/FWMaster.master" Language="vb" AutoEventWireup="true"
    Inherits="Framework2006.ProductDetails" CodeFile="ProductDetails.aspx.vb" %>
...
<asp:Content ID="Content3" runat="server" ContentPlaceHolderID="contentmain">
            ...
            <div class="twocolumn">
                ...
                <span class="inputs">
                    <asp:TextBox ID="txtFilter" runat="server" CssClass="fillspan"></asp:TextBox></span> <span class="inputicon">
                        <asp:ImageButton runat="server" ID="cmdOK" ImageUrl="~/icons/16/plain/find.gif" CausesValidation="False" /></span>
            </div>
            <div class="twocolumn">
    ...
    <asp:Panel runat="server" ID="PD_EditFieldsPanel" Visible="false">
        <div class="formpanel">
            ...
            <div class="onecolumn">
                <asp:Label ID="lblProductDescription" runat="server" AssociatedControlID="txtProductDescription">product description</asp:Label>
                <span class="inputs">
            ...
            <div class="twocolumn">
                ...
                <span class="inputs">
                    ...
                    <img src="./icons/16/plain/tooltip.png" alt="" id="imgtooltip451" onclick="showTooltip(event, 'fw', 'imgtooltip451','a0d48fef-fd13-40be-b9cf-057b181b22dd');"
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="contentmenu">
    ...
    <a href="./help_text/default_csh.htm#1064" target="_blank" class="submenuitem">Help</a>
</asp:Content>
