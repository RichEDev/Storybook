    ...
    Partial Class Home
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            If Me.IsPostBack = False Then
                ...
                Dim lstAccessRoles As List(Of Integer) = clsEmployees.GetAccessRoles(curUser.EmployeeID, curUser.CurrentSubAccountId)
        ...
        Private Sub CreateMenu()
            ...
            If curUser.CheckAccessRole(AccessRoleType.View, SpendManagementElement.Reports, True) Then
                Master.addMenuItem("chart", 48, "Reports", "Create new reports, edit, delete or view existing ones. Export data to Excel, CSV, flat file or create pivot tables.", "shared/reports/rptlist.aspx")
            End If
            Master.addMenuItem("user1_information", Master.iconSize, "My Details", "View information specific to you as a user. This option can also be used to update your profile and change your password", "MenuMain.aspx?menusection=mydetails")

            If lstAccessRoles.Count > 0 Then
                Master.addMenuItem("help", Master.iconSize, "Help and Support", "Access help resources for assistance with framework", "MenuMain.aspx?menusection=help")
                ' NEW HELP AND SUPPORT LINK - REMOVE ABOVE AND USE BELOW ONCE NEW SP IS READY
            ...
            Master.addMenuItem("trafficlight_green", 48, "GreenLight", "GreenLight means you can now take any paper based approval and put it online, click here to find out more.", "http://www.software-europe.co.uk/products/GreenLight/greenlight.html", "_blank")
            ...
            Master.addMenuItem("exit", Master.iconSize, "Exit", "Logout of " & curModule.BrandNameHTML & " and end current session", "shared/process.aspx?process=1")
        End Sub
        ...
        Private Sub SetAccountInfoPanel(ByVal curuser As CurrentUser)
            ...
            Dim tmpLstSA As ListItem() = subaccs.CreateFilteredDropDown(curuser.EmployeeID, curuser.CurrentSubAccountId)
        ...
        Private Sub SetSearchPanel(ByVal curuser As CurrentUser)
            ...
            SearchButton = "<img style=""cursor: hand;"" src=""./icons/16/plain/find.gif"" />"

            Dim permitted As Boolean = curuser.CheckAccessRole(AccessRoleType.View, SpendManagementElement.ContractDetails, False)

            litStr.Append("<input type=""text"" id=""CKSearch"" style=""width: 150px;"" value=""" & params.ContractKey & "/?/?"" alt=""Jump directly to a contract matching the specified unique key"" " & IIf(permitted, "", "disabled ") & " />")
            If permitted Then
            ...
            litStr.Append("<input type=""text"" id=""CDSearch"" style=""width: 150px;"" alt=""Search for contracts containing the search text within it's description"" " & IIf(permitted, "", "disabled ") & " />")
            If permitted Then
            ...
            litStr.Append("<input type=""text"" id=""CNSearch"" style=""width: 150px;"" alt=""Search for contracts containing the search text it's contract number"" " & IIf(permitted, "", "disabled ") & " />")
            If permitted Then
            ...
            litStr.Append("<input type=""text"" id=""PNSearch"" style=""width: 150px;"" alt=""Search for contracts associated with the search product"" " & IIf(permitted, "", "disabled ") & " />")
            If permitted Then
            ...
            litStr.Append("<input type=""text"" id=""VNSearch"" style=""width: 150px;"" alt=""View or amend the details of a " & supplierStr.ToLower & " containing search text in it's name"" " & IIf(permitted, "", "disabled ") & " />")
            If permitted Then
            ...
            litStr.Append("<input type=""radio"" style=""width: 30px;"" name=""rdoStatus"" value=""N"" checked />&nbsp;Live")
            litStr.Append("&nbsp;&nbsp;")
            litStr.Append("<input type=""radio"" style=""width: 30px;"" name=""rdoStatus"" value=""Y"" />&nbsp;Archived")
            litStr.Append("&nbsp;&nbsp;")
            litStr.Append("<input type=""radio"" style=""width: 30px;"" name=""rdoStatus"" value=""B"" />&nbsp;All")
        ...
        Private Sub GetCustomEntityOptions(ByVal curuser As CurrentUser)
            ...
            If menu_list.Count > 0 Then
                For Each ce As cCustomEntityView In menu_list
                    ...
                    entityURL = "shared/viewentities.aspx?entityid=" & centity.entityid.ToString & "&viewid=" & ce.viewid.ToString

                    Master.addMenuItem("window_dialog", fwIconSize.Large, centity.pluralname, centity.description, entityURL)
                Next
            End If
        End Sub
        ...
        Private Function checkForAdmin(ByVal cu As CurrentUser, ByVal params As cAccountProperties) As Boolean
            ...
            cu.CheckAccessRole(AccessRoleType.View, SpendManagementElement.DocumentMerge, False) Or _
            cu.CheckAccessRole(AccessRoleType.View, SpendManagementElement.DocumentTemplate, False) Or _
