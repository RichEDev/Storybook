        ...
        Private Function SearchUF(ByVal dset As DataSet, ByVal ufield As cUserDefinedField, ByVal sortField As String, ByVal fieldAlias As String, ByVal parentTable As String, ByVal params As cAccountProperties) As String
            ...
            Select Case ufield.table.tablename.ToLower
                Case "userdefinedcontractdetails"
                    ...
                    displayfields.Add(fields.getFieldByTableAndFieldName(baseTableId, "contractKey").fieldid.ToString)
                    displayfieldtype.Add("S")
                    displayfields.Add(fields.getFieldByTableAndFieldName(baseTableId, sortField).fieldid.ToString)
                    displayfieldtype.Add("S")
                    displayfields.Add("udf" & ufield.userdefineid.ToString)
                    displayfieldtype.Add("U")
                    displayfields.Add("supplierName")
                    displayfieldtype.Add("S")
                    displayfields.Add(fields.getFieldByTableAndFieldName(baseTableId, "contractValue").fieldid.ToString)
                    displayfieldtype.Add("C")
                    displayfields.Add(fields.getFieldByTableAndFieldName(baseTableId, "Archived").fieldid.ToString)
                ...
                Case "userdefinedcontractproductdetails"
                    ...
                    displayfields.Add(idfield)
                    displayfieldtype.Add("I")
                    displayfields.Add(fields.getFieldByTableAndFieldName("productDetails", sortField).fieldid.ToString)
                    displayfieldtype.Add("S")
                    displayfields.Add("udf" & ufield.userdefineid.ToString)
                    displayfieldtype.Add("U")
                ...
                Case "userdefinedproductlicences"
                    ...
                    displayfields.Add(fields.getFieldByTableAndFieldName("productDetails", sortField).fieldid.ToString)
                    displayfieldtype.Add("S")
                    displayfields.Add(fields.getFieldByTableAndFieldName("productLicences", "expiry").fieldid.ToString)
                ...
                Case "userdefinedproductdetails"
                    ...
                    displayfields.Add(fields.getFieldByTableAndFieldName(baseTableId, sortField).fieldid.ToString)
                    displayfieldtype.Add("S")
                    displayfields.Add(fields.getFieldByTableAndFieldName(baseTableId, "description").fieldid.ToString)
                ...
                Case "userdefined_employees"
                    ...
                    displayfields.Add(idfield)
                    displayfieldtype.Add("I")
                    Dim fsfield As Guid = fields.getFieldByTableAndFieldName(baseTableId, "dbo.getEmployeeFullname(employees.employeeid)").fieldid
            ...
            With strHTML
                ...
                For i As Integer = 0 To displayfields.Count - 1
                    If displayfields(i) = idfield Then
                        ...
                        .Append("<th><img src=""./icons/16/plain/view.gif"" alt=""View"" /></th>" & vbNewLine)
                    Else
                    ...
                    For Each drow As DataRow In dset.Tables(0).Rows
                        ...
                        For i As Integer = 0 To displayfields.Count - 1
                            ...
                            If displayfields(i) = idfield Then
                                ...
                                Select Case ufield.table.tablename.ToLower
                                    Case "userdefinedcontractdetails"
                                        .Append("<a href=""ContractSummary.aspx?tab=" & SummaryTabs.ContractDetail & "&id=" & CStr(drow(idfield)) & """ onmouseover=""window.status='View Record';return true;"" onmouseout=""window.status='Done';"">")
                                    Case "userdefinedcontractproductdetails"
                                    ...
                                    Case "userdefinedproductlicences"
                                        .Append("<a href=""ProductLicences.aspx?pid=" & CStr(drow(idfield)) & """ onmouseover=""window.status='View Record';return true;"" onmouseout=""window.status='Done';"">")
                                    Case "userdefinedproductdetails"
                                    ...
                                    Case "userdefinedsupplierdetails", "userdefinedsuppliercontacts"
                                        .Append("<a href=""shared/supplier_details.aspx?redir=2&supplierid=" & CStr(drow(idfield)) & """ onmouseover=""window.status='View Record';return true;"" onmouseout=""window.status='Done';"">")
                                End Select
                                .Append("<img src=""./icons/16/plain/view.gif"" alt=""View"" />")
                                .Append("</a>" & vbNewLine)
                            Else
                                Dim field As cField
                                If CStr(displayfieldtype(i)) <> "U" Then
                                    If CStr(displayfields(i)) = "supplierName" Then
                                        field = fields.getFieldByTableAndFieldName("supplier_details", "supplierName")
                                    Else
