...
#End Region
		...
		Private Sub UploadReportFile()
			...
			' clear out existing [system-dbjoins] fields
			sql = "DELETE FROM [system_dbjoins] WHERE [IsUserDefined] = 0"
			...
			'rowCount = 1
			'Do While (oneLine <> "")
			'    fieldarray = Split(oneLine, ",")

			'    errstr = AddRow(FWDb, fieldarray, rowCount)
			'    If errstr <> "" Then
			'        lblResultMsg.Text = "Upload of file aborted at " & errstr
			'        Exit Do
			'    End If
