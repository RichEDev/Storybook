...
public partial class ProductLicences : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ufields.createFieldPanel(ref phPLUFields, ptable.UserdefinedTable, "plicences", out sb);
        ...
        if (button.CommandName == "edit")
        {
            ...
            if (hiddenLicenceId.Value != "" && hiddenLicenceId.Value != "0")
            {
                ...
                if (curlicence != null)
                {
                    ...
                    lstNotify.Items.AddRange(teams.GetCombinedEmployeeListItems(true, true));
                    ...
                    {
                        udfs = ufields.GetRecord(pltable.UserdefinedTable, curlicence.LicenceId, tables, fields);
                        ufields.populateRecordDetails(ref phPLUFields, pltable.UserdefinedTable, udfs);
                    }
                    else
                    {
    ...
    protected void lnkAdd_Click(object sender, EventArgs e)
    {
        ...
        cFields fields = new cFields(curUser.AccountID);
        cTable pltable = tables.GetTableByName("productLicences");
        SortedList<int, object> udfs = ufields.GetRecord(pltable.UserdefinedTable, 0, tables, fields);
        ufields.populateRecordDetails(ref phPLUFields, pltable.UserdefinedTable, udfs);
        ViewState["record"] = udfs;
    }
    ...
    protected void cmdUpdate_Click(object sender, ImageClickEventArgs e)
    {
        ...
        cFields fields = new cFields(curUser.AccountID);
        cTable plTable = tables.GetTableByName("productLicences");
        SortedList<int, object> newrec = ufields.getItemsFromPanel(ref phPLUFields, plTable.UserdefinedTable);

        ufields.SaveValues(plTable.UserdefinedTable, int.Parse(hiddenLicenceId.Value), newrec, tables, fields, curUser);
