...
#End Region
        ...
        Private Function GetSimpleTierData(ByVal tbl As String, ByVal db As cFWDBConnection) As String
            ...
            For Each drow1 In db.glDBWorkA.Tables(0).Rows
                ...
                strHTML.Append("<th style=""width:21px;"" class=""datatbl""><img src=""./icons/edit.gif"" /></th>" & vbNewLine)
                strHTML.Append("<th style=""width:21px;"" class=""datatbl""><img src=""./icons/delete2.gif"" /></th>" & vbNewLine)
                ...
                Select Case CStr(Session("dbTableName"))
                    ...
                    Case "codes_notecategory"
                        If curUser.CheckAccessRole(AccessRoleType.Edit, SpendManagementElement.NoteCategories, False) Then
                            strHTML.Append("<td style=""width:21px;"" class=""" & rowClass & """>" & editurl & drow1.Item("noteCatId") & closeedit & "<img src=""./icons/edit.gif"" /></a></td>" & vbNewLine)
                        Else
                        ...
                        If curUser.CheckAccessRole(AccessRoleType.Delete, SpendManagementElement.NoteCategories, False) Then
                            strHTML.Append("<td style=""width:21px;"" class=""" & rowClass & """>" & deleteurl & drow1.Item("noteCatId") & "&parent=" & drow1.Item("noteType") & closedelete & "<img src=""./icons/delete2.gif"" /></a></td>" & vbNewLine)
                        Else
                            strHTML.Append("<td class=""" & rowClass & """>&nbsp;</td>" & vbNewLine)
                        End If
                ...
                'strHTML.Append("<td class=""" & rowClass & """>&nbsp;</td>" & vbNewLine)
                strHTML.Append("<th style=""width:21px;""><img src=""./icons/edit.gif"" /></th>" & vbNewLine)
                strHTML.Append("<th style=""width:21px;""><img src=""./icons/delete2.gif"" /></th>" & vbNewLine)
                    ...
                    Select Case CStr(Session("dbTableName"))
                        Case "codes_notecategory"
                            If drow2.Item("noteType") = drow1.Item("noteCatId") Then
                                ...
                                If curUser.CheckAccessRole(AccessRoleType.Edit, SpendManagementElement.NoteCategories, False) Then
                                    strHTML.Append("<td style=""width:21px;"" class=""" & rowClass2 & """>" & editurl & drow2.Item("noteCatId") & closeedit & "<img src=""./icons/edit.gif"" /></a></td>" & vbNewLine)
                                Else
                                    strHTML.Append("<td class=""" & rowClass2 & """>&nbsp;</td>" & vbNewLine)
                                End If

                                If curUser.CheckAccessRole(AccessRoleType.Delete, SpendManagementElement.NoteCategories, False) Then
                                    strHTML.Append("<td style=""width:21px;"" class=""" & rowClass2 & """>" & deleteurl & drow2.Item("noteCatId") & "&parent=" & drow2.Item("noteType") & closedelete & "<img src=""./icons/delete2.gif"" /></a></td>" & vbNewLine)
                                Else
                                    strHTML.Append("<td class=""" & rowClass2 & """>&nbsp;</td>" & vbNewLine)
                                End If
