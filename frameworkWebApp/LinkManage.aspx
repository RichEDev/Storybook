<%@ Page MasterPageFile="~/FWMaster.master" Language="vb"
    AutoEventWireup="false" Inherits="frameworkWebApp.Framework2006.LinkManage" Codebehind="LinkManage.aspx.vb" %>
...
<asp:Content ID="Content3" runat="server" ContentPlaceHolderID="contentmain">
    ...
    <div class="inputpanel formpanel_padding">
        <asp:ImageButton runat="server" ID="cmdClose" ImageUrl="./buttons/page_close.png" /></div>
        <asp:UpdateProgress runat="server" ID="ajaxLoadingPanelMain" DisplayAfter="50" AssociatedUpdatePanelID="ajaxUpdatePanel">
        <ProgressTemplate>
            <div class="inputpanel formpanel_padding">
                <div align="center">
                    <img src="shared/images/ajax-loader.gif" alt="Loading..." /></div>
            </div>
        </ProgressTemplate>
    </asp:UpdateProgress>
</asp:Content>
