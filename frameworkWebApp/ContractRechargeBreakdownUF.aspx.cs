...
public partial class ContractRechargeBreakdownUF : System.Web.UI.Page
{
    ...
    private void PopulateUFields(int cpId, int rechargeId)
    {
		...
		if (rechargeId > 0)
		{
            ...
            userfields.populateRecordDetails(ref phRAUFields, raTable.GetUserdefinedTable(), (SortedList<int, object>)ViewState["record"]);
		}
		else
		{
    ...
    protected void cmdUpdate_Click(object sender, ImageClickEventArgs e)
    {
        ...
        SortedList<int, object> newVals = userfields.getItemsFromPanel(ref phRAUFields, raTable.GetUserdefinedTable());
