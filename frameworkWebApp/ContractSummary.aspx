<%@ Page Language="VB" MasterPageFile="~/FWMaster.master" AutoEventWireup="false"
    MaintainScrollPositionOnPostback="true" Inherits="frameworkWebApp.Framework2006.ContractSummary" Codebehind="ContractSummary.aspx.vb" %>
            ...
            <asp:MultiView ID="ViewTab" runat="server" ActiveViewIndex="0">
                <asp:View ID="vwContractDetails" runat="server">
                    <asp:Panel runat="server" ID="panelVariations" Visible="false">
                        <div class="formpanel formpanel_padding_accordian">
                        <igmisc:WebPanel ID="igVariationsPanel" runat="server" CssClass="inputpanel formpanel_padding" Expanded="False">
                            <Template>
                    ...
                    <div class="formpanel formpanel_padding"><div><asp:Literal runat="server" ID="litLockStatus"></asp:Literal></div><div class="sectiontitle">Contract Details</div><div class="twocolumn"><asp:Label ID="lblUniqueKey" runat="server" AssociatedControlID="txtUniqueKeyValue"></asp:Label><span class="inputs"><asp:TextBox ID="txtUniqueKeyValue" ReadOnly="true" runat="server" CssClass="fillspan"></asp:TextBox></span><span class="inputicon">&nbsp;</span><span class="inputtooltipfield">&nbsp;</span><span class="inputvalidatorfield">&nbsp;</span><asp:Label runat="server" ID="lblContractLink" AssociatedControlID="lstLinkManage">contract links</asp:Label><span class="inputs"><asp:DropDownList ID="lstLinkManage" runat="server" CssClass="fillspan"></asp:DropDownList></span><span class="inputicon"><asp:ImageButton runat="server" ID="imgLinkManage" ImageUrl="shared/images/icons/16/plain/link.png" CausesValidation="False" /></span><span class="inputtooltipfield"><img src="./icons/16/plain/tooltip.png" alt="?" id="imgtooltip445" onclick="SEL.Tooltip.Show('2cde7282-ae30-4639-acb3-4ec2b4882bff', 'fw', this);" class="tooltipicon" /></span><span class="inputvalidatorfield">&nbsp;</span></div>
                         <div class="twocolumn"><asp:Label runat="server" ID="lblAudience" AssociatedControlID="txtAudience">Audience</asp:Label><span class="inputs"><asp:TextBox ReadOnly="true" ID="txtAudience" runat="server" TextMode="MultiLine" CssClass="fillspan" ToolTip="* indicates Team audience" Rows="1"></asp:TextBox></span><span class="inputicon"><asp:ImageButton runat="server" ID="imgAudience" ImageUrl="static/icons/16/new-icons/find.png" ToolTip="Define the audience of users permitted to access this contract" CausesValidation="False" /></span><span class="inputtooltipfield"><img src="./icons/16/plain/tooltip.png" alt="" id="imgtooltip443" onclick="SEL.Tooltip.Show('952a480f-bb8e-4e8d-93ef-f12932918060', 'fw', this);" class="tooltipicon" /></span><span class="inputvalidatorfield">&nbsp;</span><asp:Label runat="server" ID="lblSchedules" AssociatedControlID="lstSchedules">Linked Schedules</asp:Label><span class="inputs"><asp:DropDownList ID="lstSchedules" runat="server" AutoPostBack="True" OnSelectedIndexChanged="lstSchedules_SelectedIndexChanged" CssClass="fillspan"></asp:DropDownList></span><span class="inputicon"><asp:ImageButton runat="server" ID="imgSchedules" ImageUrl="shared/images/icons/16/plain/documents_gear.png" CausesValidation="false" AlternateText="Go To" /></span><span class="inputtooltipfield"><img src="./icons/16/plain/tooltip.png" alt="" id="imgtooltip444" onclick="SEL.Tooltip.Show('22bb9c7d-e189-451a-b827-9805df81be8a', 'fw', this);" class="tooltipicon" /></span><span class="inputvalidatorfield">&nbsp;</span></div>
...
class="inputvalidatorfield">&nbsp;</span><asp:Label ID="lblContractType" runat="server" AssociatedControlID="lstContractType">contract type</asp:Label><span class="inputs"><asp:DropDownList ID="lstContractType" TabIndex="4" runat="server" CssClass="fillspan"></asp:DropDownList></span><span class="inputicon">&nbsp;</span><span class="inputtooltipfield"><asp:Literal ID="litUH2" runat="server"></asp:Literal></span><span class="inputvalidatorfield">&nbsp;</span></div>
                        ...
                        <div class="onecolumnsmall"><asp:Label runat="server" ID="lblVendor" AssociatedControlID="lstVendor" CssClass="mandatory">supplier</asp:Label><span class="inputs"><asp:DropDownList ID="lstVendor" TabIndex="7" runat="server" ValidationGroup="cddetails" CssClass="fillspan"></asp:DropDownList></span><span class="inputicon"><asp:Literal runat="server" ID="litVendorLink"></asp:Literal></span><span class="inputvalidatorfield"><asp:CompareValidator ID="cmpVendor" runat="server" ErrorMessage="A Supplier must be specified" ControlToValidate="lstVendor" Operator="NotEqual" ValueToCompare="0" ValidationGroup="cddetails" CultureInvariantValues="False" Display="Dynamic" Text="*"></asp:CompareValidator></span></div><div class="twocolumn"><asp:Label ID="lblContractStatus" runat="server" AssociatedControlID="lstContractStatus">contract status</asp:Label><span class="inputs"><asp:DropDownList ID="lstContractStatus" TabIndex="9" runat="server" ValidationGroup="cddetails" CssClass="fillspan"></asp:DropDownList></span><span class="inputicon">&nbsp;</span><span class="inputtooltipfield"><img src="./icons/16/plain/tooltip.png" alt="" id="imgtooltip446" onclick="SEL.Tooltip.Show('6df35f3c-8188-4970-95be-5864709eac33', 'fw', this);" class="tooltipicon" /><asp:Literal ID="litUH4" runat="server"></asp:Literal></span><span class="inputvalidatorfield">&nbsp;</span><asp:Label ID="lblContractOwner" runat="server" AssociatedControlID="lstContractOwner">owner</asp:Label><span class="inputs"><asp:DropDownList ID="lstContractOwner" TabIndex="10" runat="server" ValidationGroup="cddetails" CssClass="fillspan"></asp:DropDownList></span><span class="inputicon">&nbsp;</span><span class="inputtooltipfield"><asp:Literal ID="litUH5" runat="server"></asp:Literal></span></div>
...
CssClass="fillspan">0</asp:TextBox></span><span class="inputicon">&nbsp;</span><span class="inputtooltipfield"><img src="./icons/16/plain/tooltip.png" alt="" id="imgtooltip448" onclick="SEL.Tooltip.Show('fa1bb5ca-be60-448c-9813-90789a33831e', 'fw', this);" class="tooltipicon" /></span><span class="inputvalidatorfield"><asp:RequiredFieldValidator ID="reqCancellationPd" runat="server" ControlToValidate="txtCancellationPeriod" ErrorMessage="A cancellation period must be specified" Display="Dynamic" Text="*" ValidationGroup="cddetails"></asp:RequiredFieldValidator><cc1:FilteredTextBoxExtender ID="fteCancellationPd" runat="server" TargetControlID="txtCancellationPeriod" FilterType="Numbers"></cc1:FilteredTextBoxExtender></span><asp:Label runat="server" ID="lblCancellationPeriodType" AssociatedControlID="lstCancellationPeriodType">Cancellation Period Type</asp:Label><span class="inputs"><asp:DropDownList runat="server" ID="lstCancellationPeriodType" AutoPostBack="True" TabIndex="26"><asp:ListItem Value="0">mths</asp:ListItem><asp:ListItem Value="1">days</asp:ListItem></asp:DropDownList></span><span class="inputicon">&nbsp;</span><span class="inputtooltipfield">&nbsp;</span><span class="inputvalidatorfield">&nbsp;</span></div>
                        ...
                        <div class="twocolumn"><asp:Label ID="lblPenaltyClause" runat="server" AssociatedControlID="chkPenaltyClause">penalty clause</asp:Label><span class="inputs"><asp:CheckBox ID="chkPenaltyClause" TabIndex="31" runat="server" CssClass="fillspan"></asp:CheckBox></span><span class="inputicon">&nbsp;</span><span class="inputtooltipfield"><img src="./icons/16/plain/tooltip.png" alt="" id="imgtooltip450" onclick="SEL.Tooltip.Show('00bebe38-1f00-4d6a-95af-3a1af582f6a2', 'fw', this);" class="tooltipicon" /></span><span class="inputvalidatorfield">&nbsp;</span><asp:Label ID="lblReviewCompleteDate" runat="server" AssociatedControlID="txtReviewCompleteDate">review complete date</asp:Label><span class="inputs"><asp:TextBox runat="server" ID="txtReviewCompleteDate" TabIndex="32" ValidationGroup="cddetails" CssClass="fillspan"></asp:TextBox></span><span class="inputicon">
...
Format="dd/MM/yyyy" TargetControlID="txtReviewCompleteDate" PopupButtonID="btnReviewComplete" PopupPosition="TopRight"></cc1:CalendarExtender>
</span><span class="inputtooltipfield"><img src="./icons/16/plain/tooltip.png" alt="" id="imgtooltip447" onclick="SEL.Tooltip.Show('40980c7a-82d3-46a9-857e-19d44b2828a9', 'fw', this);" class="tooltipicon" /></span><span class="inputvalidatorfield">&nbsp;</span></div>
                        <div class="twocolumn"><asp:Label runat="server" ID="lblNotify" AssociatedControlID="lstNotify">Notify</asp:Label><span class="inputs"><asp:TextBox ID="lstNotify" TabIndex="33" runat="server" TextMode="MultiLine" ReadOnly="True" Rows="1" CssClass="fillspan"></asp:TextBox></span><span class="inputicon"><asp:ImageButton ID="lnkNotify" runat="server" OnClick="lnkNotify_Click" AlternateText="Go To" ImageUrl="static/icons/16/new-icons/find.png" /></span><span class="inputtooltipfield">&nbsp;</span><span class="inputvalidatorfield">&nbsp;</span></div>
                        ...
                        <div>
                            <div class="div_updatedon">
                                <b>Last Changed Date:</b><asp:Label runat="server" ID="lblLastChangedValue" CssClass="left_spacing"></asp:Label></div>
                        </div>
                        ...
                        <asp:Panel runat="server" ID="CP_EditFieldsPanel" Visible="false">
                            ...
                            <div class="twocolumn">
                                <asp:Label ID="lblMaintPercent" runat="server" Text="Maintenance Percentage" AssociatedControlID="txtMaintPercent"></asp:Label><span
                                    ...
                                    class="inputvalidatorfield"></span>
                                <asp:Label ID="lblUnits" runat="server" Text="Unit Description" AssociatedControlID="lstUnits"></asp:Label><span
                ...
                <asp:View ID="vwInvoiceDetails" runat="server">
                                ...
                                <tr>
                                    ...
                                    <td class="inputtd_padded">
                                        ...
                                        <asp:CompareValidator runat="server" ID="cmpIDPOStart" ControlToValidate="dateIDPOStart"
                                            ErrorMessage="Invalid PO Start Date entered" Text="*" SetFocusOnError="true"
                                            Operator="DataTypeCheck" Type="Date" ValidationGroup="vgInvoiceDetails"></asp:CompareValidator>
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <div class="inputpanel formpanel_padding">
                        ...
                        <asp:ImageButton runat="server" ID="cmdIDClose" ImageUrl="./buttons/page_close.png"
                            CausesValidation="false" />
                    </div>
                </asp:View>
                <asp:View ID="vwInvoiceForecasts" runat="server">
                    ...
                    <asp:Panel runat="server" ID="IFBreakdownPanel" Visible="false">
                        <div class="inputpanel formpanel_padding" id="divBreakdownTable">
                    ...
                    <div class="inputpanel formpanel_padding">
                        <asp:ImageButton runat="server" ID="cmdIFClose" ImageUrl="~/buttons/page_close.png"
                            CausesValidation="false" OnClick="cmdIFClose_Click" /></div>
                </asp:View>
                <asp:View ID="vwNoteSummary" runat="server">
                    <div class="inputpanel formpanel_padding">
                        <div class="inputpanel formpanel_padding"><div class="inputpaneltitle">Note Summary<asp:Label ID="lblNSTitle" runat="server"></asp:Label></div></div>
                        <asp:Literal runat="server" ID="litNoteSummaryData"></asp:Literal>
                    </div>                
                    <div class="inputpanel formpanel_padding">
                        <asp:ImageButton runat="server" ID="cmdNSClose" ImageUrl="~/buttons/page_close.png"
                            CausesValidation="false" />
                    </div>
                </asp:View>
                <asp:View ID="vwLinkedContracts" runat="server">
                    ...
                    <div class="inputpanel formpanel_padding">
                        <asp:ImageButton runat="server" ID="cmdLCCancel" CausesValidation="false" ImageUrl="~/buttons/page_close.png" />
                    </div>
                </asp:View>
            </asp:MultiView>
        </ContentTemplate>
