<%@ Page MasterPageFile="~/FWMaster.master" Language="vb"
    AutoEventWireup="false" Inherits="frameworkWebApp.Framework2006.ImportReportFields" Codebehind="ImportReportFields.aspx.vb" %>
...
<asp:Content ID="Content3" runat="server" ContentPlaceHolderID="contentmain">
    <asp:Panel runat="server" ID="UploadSingleFile">
        ...
        <div class="inputpanel">
            <asp:ImageButton runat="server" ID="cmdOK" ImageUrl="./shared/images/buttons/ok.png" />&nbsp;&nbsp;<asp:ImageButton
            ...
            <table class="datatbl" style="width: 570px;">
                ...
                <tr>
                    <td class="row1" align="center">
                        <asp:Image runat="server" ID="imgTableDef" ImageUrl="./buttons/delete2.png" /></td>
                    <td class="row1">
                ...
                <tr>
                    <td class="row2" align="center">
                        <asp:Image runat="server" ID="imgFieldDef" ImageUrl="./buttons/delete2.png" /></td>
                    <td class="row2">
                ...
                <tr>
                    <td class="row1" align="center">
                        <asp:Image runat="server" ID="imgQueryJDef" ImageUrl="./buttons/delete2.png" /></td>
                    <td class="row1">
                        Join tables</td>
                    <td class="row1">
                ...
                <tr>
                    <td class="row2" align="center">
                        <asp:Image runat="server" ID="imgQueryJBDef" ImageUrl="./buttons/delete2.png" /></td>
                    <td class="row2">
                        Join breakdowns</td>
                    <td class="row2">
                ...
                <tr>
                    <td class="row1" align="center">
                        <asp:Image runat="server" ID="imgViewGroupDef" ImageUrl="./buttons/delete2.png" /></td>
                    <td class="row1">
                        View groups</td>
                    <td class="row1">
                ...
                <tr>
                    <td class="row2" align="center">
                        <asp:Image runat="server" ID="imgAllowedDef" ImageUrl="./buttons/delete2.png" /></td>
                    <td class="row2">
                        Allowed tables</td>
                    <td class="row2">
                ...
                <tr>
                    <td class="row1" align="center">
                        <asp:Image runat="server" ID="imgRptListItemsDef" ImageUrl="./buttons/delete2.png" /></td>
                    <td class="row1">
                ...
                <tr>
                    <td class="row2" align="center">
                        <asp:Image runat="server" ID="imgCommonFieldsDef" ImageUrl="./buttons/delete2.png" /></td>
                    <td class="row2">
                        Common fields</td>
                    <td class="row2">
