...
#End Region
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Else
                ...
                ' decrypt attachment id
                Dim tmpIdStr As String = Request.QueryString("id")

                ' if id is unencrypted, don't allow to proceed
                If Integer.TryParse(tmpIdStr, attachmentId) Or tmpIdStr.Length Mod 2 <> 0 Then
                ...
                If attachmentId > 0 Then
                    ...
                    db.DBOpen(cMigration.ConvertToFWSettings(curUser.Account, New cAccountSubAccounts(curUser.AccountID).getSubAccountsCollection, curUser.CurrentSubAccountId), False)
        ...
        Private Sub AttachmentNotFoundOrInvalid()
            Response.Redirect("~/shared/notfound.aspx?element=" & SpendManagementElement.Attachments, True)
            Response.Flush()
            Response.End()
        End Sub
        ...
        Private Sub OpenStreamFile(ByVal fileToStream As String, ByVal MIME_Header As String)
            ...
            If System.IO.File.Exists(Server.MapPath(fileToStream)) Then
