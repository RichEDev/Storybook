<%@ Page MasterPageFile="~/FWMaster.master" Language="vb" EnableTheming="true" AutoEventWireup="false" 
    Inherits="frameworkWebApp.Framework2006.Attachments" Codebehind="Attachments.aspx.vb" %>
    ...
    <asp:Panel runat="server" ID="HyperlinkPanel" Visible="false">
                <div class="inputpanel formpanel_padding">
                    ...
                    <table>
                        ...
                        <tr>
                            <td colspan="3">
                                <li class="note_attachment">NOTE: The full URL must be specified (e.g. http://&lt;full web address link&gt;)</li>
                            </td>
                        </tr>
                    </table>
                </div>
