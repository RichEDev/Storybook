<%@ Page Language="C#" MasterPageFile="~/FWMaster.master" AutoEventWireup="true" Inherits="ContractRechargeOnOffLine"
    Title="On-Off line dates" Codebehind="ContractRechargeOnOffLine.aspx.cs" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentmain" runat="Server">
    ...
    <asp:Panel runat="server" ID="curDatesPanel">
        ...
        <div class="inputpanel">
            <asp:ImageButton runat="server" ID="cmdClose" CausesValidation="false" ImageUrl="~/buttons/page_close.png
