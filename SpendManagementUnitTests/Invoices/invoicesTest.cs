...
namespace SpendManagementUnitTests
{
    ...
    /// <summary>
    ///This is a test class for invoicesTest and is intended
    ///to contain all invoicesTest Unit Tests
    ///</summary>
    [TestClass()]
    public class invoicesTest
    {
        ...
        {
            invoices target = new invoices(); // TODO: Initialize to an appropriate value
            smTemplate actual;
        ...
        //{
        //    invoices_Accessor target = new invoices_Accessor(); // TODO: Initialize to an appropriate value
        ...
        /// <summary>
        ///A test for invoices Constructor
        ///</summary>
        // TODO: Ensure that the UrlToTest attribute specifies a URL to an ASP.NET page (for example,
        // http://.../Default.aspx). This is necessary for the unit test to be executed on the web server,
        // whether you are testing a page, web service, or a WCF service.
        ...
        [AspNetDevelopmentServerHost("C:\\Inetpub\\wwwroot\\Spend Management\\Spend Management_root\\Spend Management", "/")]
        [UrlToTest("http://localhost:3237/")]
        public void invoicesConstructorTest()
        {
            invoices target = new invoices();
