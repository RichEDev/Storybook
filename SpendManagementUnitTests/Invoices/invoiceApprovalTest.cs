...
namespace SpendManagementUnitTests
{
    ...
    /// <summary>
    ///This is a test class for invoiceApprovalTest and is intended
    ///to contain all invoiceApprovalTest Unit Tests
    ///</summary>
    [TestClass()]
    public class invoiceApprovalTest
    {
        ...
        {
            invoiceApproval target = new invoiceApproval(); // TODO: Initialize to an appropriate value
            smPagedForm actual;
        ...
        //{
        //    invoiceApproval_Accessor target = new invoiceApproval_Accessor(); // TODO: Initialize to an appropriate value
        ...
        /// <summary>
        ///A test for invoiceApproval Constructor
        ///</summary>
        // TODO: Ensure that the UrlToTest attribute specifies a URL to an ASP.NET page (for example,
        // http://.../Default.aspx). This is necessary for the unit test to be executed on the web server,
        // whether you are testing a page, web service, or a WCF service.
        ...
        [AspNetDevelopmentServerHost("C:\\Inetpub\\wwwroot\\Spend Management\\Spend Management_root\\Spend Management", "/")]
        [UrlToTest("http://localhost:3237/")]
        public void invoiceApprovalConstructorTest()
        {
            invoiceApproval target = new invoiceApproval();
