...
namespace SpendManagementUnitTests
{
    ...
    public class cMimeTypesTest
    {
        ...
        {
            cMimeTypes target = new cMimeTypes(cGlobalVariables.AccountID, cGlobalVariables.SubAccountID);
        ...
        public void cMimeTypes_CacheListTest()
        {
             ...
             {
                 mime = cMimeTypeObject.CreateMimeType();
                 Cache.Remove("MimeTypes" + cGlobalVariables.AccountID);

                 cMimeTypes clsMimeTypes = new cMimeTypes(cGlobalVariables.AccountID, cGlobalVariables.SubAccountID);
                 SortedList<int, cMimeType> expected = (SortedList<int, cMimeType>)Cache["MimeTypes" + cGlobalVariables.AccountID];
