...
namespace ApiLibrary.ApiObjects.ESR
{
    ...
    public class EsrHeaderRecord
    {
        ...
        public DateTime PreviousRunDate
        {
            get
            {
                return previousFileExtractDate;
            }
        }
        ...
        public EsrHeaderRecord(string filename, DateTime creationDate, string trustVpd, DateTime previousRunDate, DateTime runDate, string interfaceversion)
        {
            ...
            if (!int.TryParse(trustVpd, out vpdNumber))
            {
                vpdNumber = -1;
            }

            previousFileExtractDate = previousRunDate;
            fileExtractDate = runDate;
            interfaceVersion = interfaceversion;

            string tmpVpd;
            ParseOutboundFilename(filename, out extractTypeCode, out uniqueFileSequenceId, out tmpVpd);
        }
