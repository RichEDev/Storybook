namespace WebBootstrap
{
    ...
    public static class Bootstraper
    {
        public static Container Bootstrap()
        {
            ...
            container.Register(() => IdentityFactory.Create(HttpContext.Current));
        ...
        private static void RegisterWebPages(Container container)
        {
            var pageTypes =
                ...
                where type.IsSubclassOf(typeof(Page)) || type.IsSubclassOf(typeof(System.Web.Services.WebService)) || type.IsSubclassOf(typeof(UserControl))
