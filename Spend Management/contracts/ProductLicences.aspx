<%@ Page Language="C#" MasterPageFile="~/masters/smForm.master" AutoEventWireup="true" Inherits="Spend_Management.ProductLicences" Title="Product Licences" Codebehind="ProductLicences.aspx.cs" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentmain" runat="Server">
    ...
    <asp:Panel runat="server" ID="panelEdit">
        <div class="formpanel formpanel_padding"><div class="sectiontitle">Licence Details</div><div class="onecolumn"><asp:Label runat="server" Text="Licence Key" ID="lblLicenceKey" AssociatedControlID="txtKey"></asp:Label><span class="inputs"><asp:TextBox runat="server" ID="txtKey" MaxLength="250" TabIndex="1" CssClass="fillspan"
...
<span class="inputvalidatorfield">&nbsp;</span></div><div class="twocolumn"><asp:Label runat="server" ID="lblSoftCopy" AssociatedControlID="chkSoftCopy" Text="Soft Copy Held"></asp:Label><span class="inputs"><asp:CheckBox runat="server" ID="chkSoftCopy" TabIndex="9" CssClass="fillspan" /></span><span class="inputicon">&nbsp;</span><span class="inputtooltip">&nbsp;</span><span class="inputvalidatorfield">&nbsp;</span><asp:Label runat="server" Text="Hard Copy Held" AssociatedControlID="chkHardCopy" ID="lblHardCopy"></asp:Label><span class="inputs"><asp:CheckBox runat="server" ID="chkHardCopy" TabIndex="10" CssClass="fillspan" /></span><span class="inputicon">&nbsp;</span> <span class="inputtooltip">&nbsp;</span><span class="inputvalidatorfield">&nbsp;</span></div><div class="twocolumn"><asp:Label runat="server" ID="lblNumLicences" AssociatedControlID="txtNumberHeld" Text="Number Licences Held"></asp:Label><span class="inputs"><asp:TextBox runat="server" ID="txtNumberHeld" TabIndex="11" CssClass="fillspan"></asp:TextBox></span><span class="inputicon">&nbsp;</span><span class="inputtooltip">&nbsp;</span><span class="inputvalidatorfield"><asp:CompareValidator ID="cmpNumberHeld" runat="server" ControlToValidate="txtNumberHeld" ErrorMessage="Value entered must be numeric" Operator="DataTypeCheck" Type="Integer" Display="Dynamic" ValidationGroup="plicences">*</asp:CompareValidator></span><asp:HiddenField runat="server" ID="hiddenLicenceId" /></div><asp:PlaceHolder runat="server" ID="phPLUFields"></asp:PlaceHolder></div><div class="formpanel formpanel_padding"><asp:ImageButton runat="server" ID="cmdUpdate" ImageUrl="~/Buttons/update.gif" AlternateText="Update" OnClick="cmdUpdate_Click" ValidationGroup="plicences" />&nbsp;<asp:ImageButton runat="server" ID="cmdCancel" ImageUrl="~/Buttons/cancel.gif" AlternateText="Cancel" CausesValidation="false" OnClick="cmdCancel_Click" /></div>
