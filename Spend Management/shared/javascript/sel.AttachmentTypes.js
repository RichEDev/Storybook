            ...
            DeleteAttachmentTypeComplete: function (retVal) {
                switch (retVal) {
                    ...
                    case -2:
                        ...
                        break;
                    case -3:
                        SEL.MasterPopup.ShowMasterPopup('This attachment type is currently in use on a Notification Template attachment, it must be removed from all notification template records before it can be deleted.');
                        break;
                    case -4:
