        ...
        <div class="formpanel">
            ...
            <asp:Label AssociatedControlID="ddlCountry" ID="lblCountry" runat="server" CssClass="mandatory">Country*</asp:Label><span class="inputs" ><asp:DropDownList ClientIDMode="Static" ID="ddlCountry" onchange ="OnBankDetailsTextBoxChanged()" runat="server"  onkeydown="SEL.Forms.RunOnEnter(event, SEL.BankAccounts.SaveBankAccountOnEnter);"></asp:DropDownList></span><span class="inputicon">&nbsp;</span><span class="inputtooltipfield"><img id="img5" onmouseover="SEL.Tooltip.Show('B6AF95ED-C112-4F3F-921B-0318A95F93D4', 'sm', this);" src="../images/icons/16/plain/tooltip.png" alt="" class="tooltipicon" /></span><span class="inputvalidatorfield">
                <asp:CompareValidator ID="rvCountry" runat="server" ControlToValidate="ddlCountry" ErrorMessage="Please select a Country." Operator="GreaterThan" Type="Integer" ValidationGroup="vgAddEditAccount" ValueToCompare="0">*</asp:CompareValidator> </span>
                     ...
                     <asp:Label AssociatedControlID="txtIbanCode" ID="lblIbanCode" runat="server">IBAN</asp:Label><span class="inputs"><asp:TextBox ID="txtIbanCode" runat="server" MaxLength="20" onkeydown="SEL.Forms.RunOnEnter(event, SEL.BankAccounts.SaveBankAccountOnEnter);"></asp:TextBox></span><span class="inputicon">&nbsp;</span><span class="inputtooltipfield"><img id="imgtooltip532" onmouseover="SEL.Tooltip.Show('5C36049A-E73A-41EA-B331-AE1BFF52D8EE', 'sm', this);" src="../images/icons/16/plain/tooltip.png" alt="" class="tooltipicon" /></span><span class="inputvalidatorfield"><asp:RegularExpressionValidator runat="server" ID="RegularExpressionValidator1" ErrorMessage="The IBAN Code specified must be between 5 and 34 characters" ValidationGroup="vgAddEditAccount"  ValidationExpression="^.{5,34}$" ControlToValidate="txtIbanCode" Display="None"></asp:RegularExpressionValidator>
                         </span>
           </div>
        <div class="twocolumn">
            <asp:Label AssociatedControlID="txtSwiftCode" ID="lblSwiftCode" runat="server">SWIFT Code</asp:Label><span class="inputs"><asp:TextBox ID="txtSwiftCode" runat="server" MaxLength="20" onkeydown="SEL.Forms.RunOnEnter(event, SEL.BankAccounts.SaveBankAccountOnEnter);"></asp:TextBox></span><span class="inputicon">&nbsp;</span><span class="inputtooltipfield"><img id="imgtooltip532" onmouseover="SEL.Tooltip.Show('6B50F6C0-5334-4DA7-B768-AE07174DC043', 'sm', this);" src="../images/icons/16/plain/tooltip.png" alt="" class="tooltipicon" /></span><span class="inputvalidatorfield"><asp:RegularExpressionValidator runat="server" ID="RegularExpressionValidator2" ErrorMessage="The SWIFT Code specified must be between 8 and 11 characters" ValidationGroup="vgAddEditAccount"  ValidationExpression="^.{8,11}$" ControlToValidate="txtSwiftCode" Display="None"></asp:RegularExpressionValidator>
            </span>
            </div>
