namespace SQLDataAccess.ProductModules
{
    ...
    public class SqlProductModulesWithElementsFactory
    {
        /// <summary>
        ...
        /// </summary>
        private readonly SqlProductModulesFactory _sqlProductModulesFactory;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SqlProductModulesWithElementsFactory"/> class.
        /// </summary>
        /// <param name="cacheFactory">
        /// An instance of <see cref="MetabaseCacheFactory{T,TK}"/> to handle caching of <see cref="IProductModuleWithElements"/> instances.
        /// </param>
        /// <param name="sqlProductModulesFactory">
        /// An instance of <see cref="SqlProductModulesFactory"/> to decorate with licenced elements
        /// </param>
        ...
        /// </exception>
        /// <exception cref="ArgumentNullException">
        /// <paramref name="sqlProductModulesFactory"/> is <see langword="null"/>.
        /// </exception>
        /// <exception cref="ArgumentNullException">
        ...
        /// </exception>
        public SqlProductModulesWithElementsFactory(MetabaseCacheFactory<IProductModuleWithElements, int> cacheFactory, SqlProductModulesFactory sqlProductModulesFactory, SqlElementFactory sqlElementFactory, IMetabaseDataConnection<SqlParameter> metabaseDataConnection)
        {
            Guard.ThrowIfNull(metabaseDataConnection, nameof(metabaseDataConnection));
            Guard.ThrowIfNull(sqlProductModulesFactory, nameof(sqlProductModulesFactory));
            Guard.ThrowIfNull(sqlElementFactory, nameof(sqlElementFactory));
            Guard.ThrowIfNull(cacheFactory, nameof(cacheFactory));

            this._cacheFactory = cacheFactory;
            this._sqlProductModulesFactory = sqlProductModulesFactory;
        ...
        public IProductModuleWithElements this[Modules id]
        {
            get
            {
                ...
                {
                    IProductModule account = this._sqlProductModulesFactory[id];
        ...
        public IList<IProductModuleWithElements> Get()
        {
            ...
            if (accountWithElement == null)
            {
                IList<IProductModule> accounts = this._sqlProductModulesFactory.Get();
