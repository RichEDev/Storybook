...
namespace Auto_Tests
{
    ...
    public class DeleteExpenseCategory : WebTest
    {
        ...
        public override IEnumerator<WebTestRequest> GetRequestEnumerator()
        {
            ...
            WebTestRequest request30 = new WebTestRequest((this.Context["WebServer1"].ToString() + "/admin/admincategories.aspx"));
            ...
            WebTestRequest request6 = new WebTestRequest(this.Context["WebServer1"].ToString() + "/admin/admincategories.aspx/deleteCategory");
            ...
            request6Body.BodyString = "{\"accountid\":" + accountid + ",\"categoryid\":" + id + "}";
            request6.Body = request6Body;
            yield return request6;
            request6 = null;

            WebTestRequest request7 = new WebTestRequest(this.Context["WebServer1"].ToString() + "/admin/admincategories.aspx");
