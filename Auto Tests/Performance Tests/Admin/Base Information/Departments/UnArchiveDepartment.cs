...
namespace Auto_Tests
{
    ...
    public class UnArchiveDepartment : WebTest
    {

        public UnArchiveDepartment()
        {
        ...
        public override IEnumerator<WebTestRequest> GetRequestEnumerator()
        {
            ...
            WebTestRequest request6 = new WebTestRequest(this.Context["WebServer1"].ToString() + "/shared/admin/admindepartments.aspx/changeStatus");
            ...
            request6Body.BodyString = "{\"accountid\":" + accountid + ",\"departmentid\":" + id + "}";
            request6.Body = request6Body;
            yield return request6;
            request6 = null;

            WebTestRequest request7 = new WebTestRequest(this.Context["WebServer1"].ToString() + "/shared/admin/admindepartments.aspx");
