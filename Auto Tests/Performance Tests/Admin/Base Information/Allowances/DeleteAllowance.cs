...
namespace Auto_Tests
{
    ...
    public class DeleteAllowance : WebTest
    {
        ...
        public override IEnumerator<WebTestRequest> GetRequestEnumerator()
        {
            ...
            WebTestRequest request6 = new WebTestRequest(this.Context["WebServer1"].ToString() + "/expenses/admin/adminallowances.aspx/deleteAllowance" +
                    "");
            ...
            WebTestRequest request7 = new WebTestRequest(this.Context["WebServer1"].ToString() + "/expenses/admin/adminallowances.aspx");
