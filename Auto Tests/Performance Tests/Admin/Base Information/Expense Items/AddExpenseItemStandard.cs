...
namespace Auto_Tests
{
    ...
    public class AddExpenseItemStandard : WebTest
    {

        public AddExpenseItemStandard()
        {
        ...
        public override IEnumerator<WebTestRequest> GetRequestEnumerator()
        {
            ...
            // Extract values for expense Cat and P11D Cat
            ...
            extractionRule3.StartsWith = "P11d Category</label>";
            extractionRule3.EndsWith = "Account Code</label>";
            ...
            request7Body.BodyString = @"{""subcatid"":0,""subcat"":""__Auto Standard Item"",""categoryid"":" + 
                expenseCatID + @",""accountcode"":""123"",""description"":""Automatically generated Standard " +
                @"expense item"",""allowanceamount"":0,""addasnet"":false,""mileageapp"":false,""staffapp"":" +
                ...
                @"entertainmentid"":0,""pdcatid"":" + P11Cat + @",""reimbursable"":false,""nonights"":false,""hotelapp"":false,""" +
