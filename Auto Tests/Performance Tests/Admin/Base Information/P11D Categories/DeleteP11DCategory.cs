...
namespace Auto_Tests
{
    ...
    public class DeleteP11DCategory : WebTest
    {

        public DeleteP11DCategory()
        {
        ...
        public override IEnumerator<WebTestRequest> GetRequestEnumerator()
        {
            ...
            WebTestRequest request30 = new WebTestRequest((this.Context["WebServer1"].ToString() + "/admin/adminp11d.aspx"));
            ...
            WebTestRequest request6 = new WebTestRequest((this.Context["WebServer1"].ToString() + "/admin/adminp11d.aspx/deleteP11d"));
            ...
            request6Body.BodyString = "{\"accountid\":" + accountid + ",\"pdcatid\":" + P11ID + "}";
            request6.Body = request6Body;
            yield return request6;
            request6 = null;

            WebTestRequest request7 = new WebTestRequest((this.Context["WebServer1"].ToString() + "/admin/adminp11d.aspx"));
