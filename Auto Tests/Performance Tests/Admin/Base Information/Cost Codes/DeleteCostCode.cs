...
namespace Auto_Tests
{
    ...
    public class DeleteCostCode : WebTest
    {

        public DeleteCostCode()
        {
        ...
        public override IEnumerator<WebTestRequest> GetRequestEnumerator()
        {
            ...
            WebTestRequest request6 = new WebTestRequest(this.Context["WebServer1"].ToString() + "/shared/admin/admincostcodes.aspx/deleteCostcode");
