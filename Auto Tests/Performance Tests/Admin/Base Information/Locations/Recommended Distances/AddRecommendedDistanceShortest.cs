...
namespace Auto_Tests
{
    ...
    public class AddRecommendedDistanceShortest : WebTest
    {

        public AddRecommendedDistanceShortest()
        {
        ...
        public override IEnumerator<WebTestRequest> GetRequestEnumerator()
        {
            ...
            // Make sure postcode calculation type is set to 'shortest'
            foreach (WebTestRequest r in IncludeWebTest(new Auto_Tests.GeneralOptionsEdit("tabsNewExpenses$tabmileage$cmbmileagecalculationtype", "1", "list"), false)) { yield return r; }
            ...
            if ((this.Context.ValidationLevel >= Microsoft.VisualStudio.TestTools.WebTesting.ValidationLevel.High))
            {
                ...
                validationRule2.FindText = "__Auto Recommended Test 2</td><td class=\"row([1-2])\">0.00</td><td class=\"row([1-2])\">44.00";
