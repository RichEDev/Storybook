...
namespace Auto_Tests
{
    ...
    public class UpdatingMyDetails : WebTest
    {

        public UpdatingMyDetails()
        {            
        ...
        public override IEnumerator<WebTestRequest> GetRequestEnumerator()
        {
            ...
            AutoTools.ValidateText("Home</a></span>", request6);
            AutoTools.ValidateText("My Details</a></span>", request6);
            AutoTools.ValidateText("Change My Details</span>", request6);
            ...
            request7Body.FormPostParameters.Add("ctl00$contentmain$lblusername", reader.GetValue(0).ToString());
