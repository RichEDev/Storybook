...
namespace Auto_Tests
{
    ...
    public class AddDailyAllowanceExpense : WebTest
    {

        public AddDailyAllowanceExpense()
        {
        ...
        public override IEnumerator<WebTestRequest> GetRequestEnumerator()
        {
            ...
            System.Data.SqlClient.SqlDataReader subcatReader = subcatDB.GetReader("SELECT subcatid FROM subcats WHERE subcat = '__Auto Daily Allowance Item'");
            subcatReader.Read();
            ...
            request11Body.FormPostParameters.Add("ctl00$contentmain$cmballowance0", "8");
            request11Body.FormPostParameters.Add("ctl00$contentmain$txtstartdate0", "01/03/2010");
            request11Body.FormPostParameters.Add("ctl00$contentmain$mskstartdate0_ClientState", this.Context["$HIDDEN1.ctl00$contentmain$mskstartdate0_ClientState"].ToString());
            request11Body.FormPostParameters.Add("ctl00$contentmain$txtstarttime0", "09:00");
            request11Body.FormPostParameters.Add("ctl00$contentmain$mskstarttime0_ClientState", this.Context["$HIDDEN1.ctl00$contentmain$mskstarttime0_ClientState"].ToString());
            request11Body.FormPostParameters.Add("ctl00$contentmain$txtenddate0", "02/03/2010");
            request11Body.FormPostParameters.Add("ctl00$contentmain$mskenddate0_ClientState", this.Context["$HIDDEN1.ctl00$contentmain$mskenddate0_ClientState"].ToString());
            request11Body.FormPostParameters.Add("ctl00$contentmain$txtendtime0", "17:00");
            request11Body.FormPostParameters.Add("ctl00$contentmain$mskendtime0_ClientState", this.Context["$HIDDEN1.ctl00$contentmain$mskendtime0_ClientState"].ToString());
            request11Body.FormPostParameters.Add("ctl00$contentmain$txtdeductamount0", "50");
            ...
            if (detailsReader.HasRows)
            {
                ...
                request11Body.FormPostParameters.Add("ctl00$contentmain$txtudf" + udfDetails + "0", "Testing daily allowances");
            }
            detailsReader.Close();            
            ...
            if ((this.Context.ValidationLevel >= Microsoft.VisualStudio.TestTools.WebTesting.ValidationLevel.High))
            {
                ...
                if (udfDetails != "")
                {
                    expenseVal.Add("contentmain$txtudf" + udfDetails + "0\" type=\"text\" value=\"Testing daily allowances\"");
                }
