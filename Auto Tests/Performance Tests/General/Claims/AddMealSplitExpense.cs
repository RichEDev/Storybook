...
namespace Auto_Tests
{
    ...
    public class AddMealSplitExpense : WebTest
    {

        public AddMealSplitExpense()
        {
        ...
        public override IEnumerator<WebTestRequest> GetRequestEnumerator()
        {
            ...
            System.Data.SqlClient.SqlDataReader subcatReader = subcatDB.GetReader("SELECT subcatid FROM subcats WHERE subcat = '__Auto Meal Split Item'");
            subcatReader.Read();
            ...
            request11Body.FormPostParameters.Add("ctl00$contentmain$txtdirectors0", "0");
            request11Body.FormPostParameters.Add("ctl00$contentmain$txtstaff0", "2");
            request11Body.FormPostParameters.Add("ctl00$contentmain$txtothers0", "2");
            request11Body.FormPostParameters.Add("ctl00$contentmain$txtpersonalguests0", "1");
            request11Body.FormPostParameters.Add("ctl00$contentmain$txtremoteworkers0", "1");
            request11Body.FormPostParameters.Add("ctl00$contentmain$txtattendees0", "Test people");
            ...
            if (detailsReader.HasRows)
            {
                ...
                request11Body.FormPostParameters.Add("ctl00$contentmain$txtudf" + udfDetails + "0", "Testing meal split expense item");
            }
            detailsReader.Close();
            ...
            if ((this.Context.ValidationLevel >= Microsoft.VisualStudio.TestTools.WebTesting.ValidationLevel.High))
            {
                ...
                expenseVal.Add("txtothers0\" type=\"text\" value=\"2\"");
                expenseVal.Add("txtremoteworkers0\" type=\"text\" value=\"1\"");
                expenseVal.Add("txtattendees0\">Test people</textarea>");
                expenseVal.Add("txttip0\" type=\"text\" value=\"5.00\"");
                expenseVal.Add("value=\"optnormalreceiptyes0\" checked=\"checked\"");
                expenseVal.Add("opteventinhomeyes0\">Yes</label>");                
                expenseVal.Add("txttotal0\" type=\"text\" value=\"50.00\"");
                if (udfDetails != "")
                {
                    expenseVal.Add("contentmain$txtudf" + udfDetails + "0\" type=\"text\" value=\"Testing meal split expense item\"");
                }
