...
namespace Auto_Tests
{
    ...
    public class AddStandardExpense : WebTest
    {

        public AddStandardExpense()
        {
        ...
        public override IEnumerator<WebTestRequest> GetRequestEnumerator()
        {
            ...
            System.Data.SqlClient.SqlDataReader subcatReader = subcatDB.GetReader("SELECT subcatid FROM subcats WHERE subcat = '__Auto Standard Item'");
            subcatReader.Read();
