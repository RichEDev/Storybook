...
namespace Auto_Tests
{
    ...
    public class AddMileageExpense : WebTest
    {

        public AddMileageExpense()
        {
        ...
        public override IEnumerator<WebTestRequest> GetRequestEnumerator()
        {
            ...
            System.Data.SqlClient.SqlDataReader subcatReader = subcatDB.GetReader("SELECT subcatid FROM subcats WHERE subcat = '__Auto Mileage Item'");
            subcatReader.Read();
            ...
            request11Body.FormPostParameters.Add("ctl00$contentmain$txtmileage0", "200");
            request11Body.FormPostParameters.Add("ctl00$contentmain$txtpassengers0", "1");
            ...
            if (detailsReader.HasRows)
            {
                ...
                request11Body.FormPostParameters.Add("ctl00$contentmain$txtudf" + udfDetails + "0", "Testing mileage item");
            }
            detailsReader.Close();
            ...
            if ((this.Context.ValidationLevel >= Microsoft.VisualStudio.TestTools.WebTesting.ValidationLevel.High))
            {
                ...
                expenseVal.Add("200.00");
                expenseVal.Add("txtpassengers0\" type=\"text\" value=\"1\"");
