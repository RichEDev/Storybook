...
namespace Auto_Tests
{
    ...
    public class AddMealExpense : WebTest
    {

        public AddMealExpense()
        {
        ...
        public override IEnumerator<WebTestRequest> GetRequestEnumerator()
        {
            ...
            System.Data.SqlClient.SqlDataReader subcatReader = subcatDB.GetReader("SELECT subcatid FROM subcats WHERE subcat = '__Auto Meal Item'");
            subcatReader.Read();
            ...
            request11Body.FormPostParameters.Add("ctl00$contentmain$txtothers0", "1");
            request11Body.FormPostParameters.Add("ctl00$contentmain$txttip0", "2");
            request11Body.FormPostParameters.Add("ctl00$contentmain$normalreceipt0", "optnormalreceiptyes0");
            request11Body.FormPostParameters.Add("ctl00$contentmain$txttotal0", "20");
            request11Body.FormPostParameters.Add("ctl00$contentmain$cmbpaymentmethod0", "1");
            ...
            if (detailsReader.HasRows)
            {
                ...
                request11Body.FormPostParameters.Add("ctl00$contentmain$txtudf" + udfDetails + "0", "Testing meal expense item");
            }
            detailsReader.Close();
            ...
            if ((this.Context.ValidationLevel >= Microsoft.VisualStudio.TestTools.WebTesting.ValidationLevel.High))
            {
                ...
                expenseVal.Add("txtothers0\" type=\"text\" value=\"1\"");
                expenseVal.Add("txttip0\" type=\"text\" value=\"2.00\"");
                expenseVal.Add("value=\"optnormalreceiptyes0\" checked=\"checked\"");
                expenseVal.Add("txttotal0\" type=\"text\" value=\"20.00\"");
                if (udfDetails != "")
                {
                    expenseVal.Add("contentmain$txtudf" + udfDetails + "0\" type=\"text\" value=\"Testing meal expense item\"");
                }
