...
namespace Auto_Tests
{
    ...
    public class ExpensesSelectEmployeesCoded : WebTest
    {

        public ExpensesSelectEmployeesCoded()
        {
        ...
        public override IEnumerator<WebTestRequest> GetRequestEnumerator()
        {
            ...
            WebTestRequest request2Dependent1 = new WebTestRequest("http://localhost/main/expenses/shared/css/styles.aspx");
            request2Dependent1.QueryStringParameters.Add("style", "logon", false, false);
            request2.DependentRequests.Add(request2Dependent1);
            WebTestRequest request2Dependent2 = new WebTestRequest("http://localhost/main/expenses/shared/webServices/svcTooltip.asmx/jsdebug");
            request2.DependentRequests.Add(request2Dependent2);
            WebTestRequest request2Dependent3 = new WebTestRequest("http://localhost/main/expenses/shared/");
            request2Dependent3.ThinkTime = 12;
            request2Dependent3.ExpectedResponseUrl = "http://localhost/main/expenses/shared/logon.aspx?ReturnUrl=%2fshared%2f";
            ...
            request3Body.FormPostParameters.Add("txtUsername", "james");
            ...
            cDatabaseConnection database = new cDatabaseConnection("Data Source=JAMESLT\\SQLEXPRESS;Initial Catalog=loadtestdatabase;Persist Security Info=True;User ID=spenduser;Password=P3ngu1ns");
            System.Data.SqlClient.SqlDataReader reader = database.GetReader("SELECT employeeid FROM employees");
            WebTestRequest request4;

            while (reader.Read())
            {
                request4 = new WebTestRequest("http://localhost/main/expenses/shared/admin/aeemployee.aspx");
                request4.QueryStringParameters.Add("employeeid", reader.GetValue(0).ToString(), false, false);
