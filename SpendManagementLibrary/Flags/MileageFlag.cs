namespace SpendManagementLibrary.Flags
{
    ...
    /// </summary>
    [Serializable]
    public class MileageFlag : ToleranceFlag
    {
        /// <summary>
        /// Initialises a new instance of the <see cref="MileageFlag"/> class.
        /// </summary>
        /// <param name="flagid">
        /// The flagid.
        /// </param>
        ...
        /// </param>
        public MileageFlag(int flagid, FlagType flagtype, FlagAction action, string flagtext, List<int> associateditemroles, List<AssociatedExpenseItem> associatedexpenseitems, DateTime createdon, int? createdby, DateTime? modifiedon, int? modifiedby, decimal? ambertolerance, string description, bool active, int accountid, bool claimantjustificationrequired, bool displayflagimmediately, decimal? flagTolerancePercentage, FlagColour flaglevel, bool approverjustificationrequired, string notesforauthoriser, FlagInclusionType itemroleinclusiontype, FlagInclusionType expenseiteminclusiontype)
            : base(flagid, flagtype, action, flagtext, associateditemroles, associatedexpenseitems, createdon, createdby, modifiedon, modifiedby, ambertolerance, description, active, accountid, claimantjustificationrequired, displayflagimmediately, flagTolerancePercentage, flaglevel, approverjustificationrequired, notesforauthoriser, "Recommended Distance Exceeded", string.Empty, itemroleinclusiontype, expenseiteminclusiontype, true, false, false, false)
        {
        ...
        {
            throw new NotImplementedException("Implemented elsewhere");
        }
    }
}
