namespace SpendManagementLibrary.Flags
{
    ...
    /// <summary>
    /// The home to office flag.
    /// </summary>
    [Serializable]
    public class HomeToOfficeFlag : Flag
    {
        /// <summary>
        /// Initialises a new instance of the <see cref="HomeToOfficeFlag"/> class.
        /// </summary>
        /// <param name="flagid">
        /// The flagid.
        /// </param>
