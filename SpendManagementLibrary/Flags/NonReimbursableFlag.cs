namespace SpendManagementLibrary.Flags
{
    ...
    /// <summary>
    /// The non reimbursable flag.
    /// </summary>
    [Serializable]
    public class NonReimbursableFlag : Flag
    {
        /// <summary>
