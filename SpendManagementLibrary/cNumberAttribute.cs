namespace SpendManagementLibrary
{
    ...
    public class cNumberAttribute : cAttribute
    {
        ...
        /// <summary>
        /// Create a new instance of <see cref="cNumberAttribute"/>
        /// </summary>
        ...
        public cNumberAttribute(int attributeid, string attributename, string displayname, string description, string tooltip, bool mandatory, FieldType fieldtype, DateTime createdon, int createdby, DateTime? modifiedon, int? modifiedby, byte precision, Guid fieldid, bool iskeyfield, bool isauditidentity, bool isunique, bool allowedit, bool allowdelete, bool displayInMobile, bool builtIn, bool system_attribute)
            : base(attributeid, attributename, displayname, description, tooltip, mandatory, fieldtype, createdon, createdby, modifiedon, modifiedby, fieldid, iskeyfield, isauditidentity, isunique, allowedit, allowdelete, displayInMobile, builtIn, false, system_attribute, false)
        {
