namespace SpendManagementLibrary.Claims
{
    ...
    public class ClaimSubmissionApi
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether the claim can be submitted partly.
        /// </summary>
        public bool PartSubmittal { get; set; }

        /// <summary>
        ///  Gets or sets items to show the part submittal section.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the submit claim result whether it can be submitted or not.
        /// </summary>
