namespace SpendManagementLibrary.MobileDeviceNotifications.NotificationManager
{
	...
	public class PushNotificationManagerWP : IPushNotificationManager
	{
		/// <summary>
		/// An instance of <see cref="ILog"/> for logging diagnostics and information.
		/// </summary>
		private static readonly ILog Log = new LogFactory<PushNotificationManagerWP>().GetLogger();
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="PushNotificationManagerWP"/> class.
		/// </summary>
		/// <param name="notificationMessage">The notification message</param>
		/// <param name="registeredTag">The  registered tag</param>
		public PushNotificationManagerWP(string notificationMessage, string registeredTag)
		{
		...
		public async Task<bool> SendPushMessageAsync(string azureHubConnectionString, string azureHubName)
		{
			...
			NotificationOutcome outcome = await hub.SendMpnsNativeNotificationAsync(this.notificationMessage, this.registeredTag);
