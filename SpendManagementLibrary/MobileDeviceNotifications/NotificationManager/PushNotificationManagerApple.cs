namespace SpendManagementLibrary.MobileDeviceNotifications.NotificationManager
{
	...
	public class PushNotificationManagerApple : IPushNotificationManager
	{
		/// <summary>
		/// An instance of <see cref="ILog"/> for logging diagnostics and information.
		/// </summary>
		private static readonly ILog Log = new LogFactory<PushNotificationManagerApple>().GetLogger();
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="PushNotificationManagerApple"/> class.
		/// </summary>
		/// <param name="notificationMessage">The notification message</param>
		/// <param name="registeredTag">The  registered tag</param>
		public PushNotificationManagerApple(string notificationMessage, string registeredTag)
		{
		...
		/// <returns>Status of sending push messages</returns>
		public async Task<bool> SendPushMessageAsync(string azureHubConnectionString, string azureHubName)
		{
			...
			NotificationOutcome outcome = await hub.SendAppleNativeNotificationAsync(this.notificationMessage, this.registeredTag);
