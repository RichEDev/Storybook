namespace SpendManagementLibrary.MobileDeviceNotifications.NotificationManager
{
	...
	public class PushNotificationManagerUWP : IPushNotificationManager
	{
		/// <summary>
		/// An instance of <see cref="ILog"/> for logging diagnostics and information.
		/// </summary>
		private static readonly ILog Log = new LogFactory<PushNotificationManagerUWP>().GetLogger();
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="PushNotificationManagerUWP"/> class.
		/// </summary>
		/// <param name="notificationMessage">The notification message</param>
		/// <param name="registeredTag">The  registered tag</param>
		public PushNotificationManagerUWP(string notificationMessage, string registeredTag)
		{
		...
		public async Task<bool> SendPushMessageAsync(string azureHubConnectionString, string azureHubName)
		{
			...
			NotificationOutcome outcome = await hub.SendWindowsNativeNotificationAsync(this.notificationMessage, this.registeredTag);
