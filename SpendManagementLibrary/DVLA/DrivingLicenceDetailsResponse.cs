namespace SpendManagementLibrary.DVLA
{
    ...
    public class DrivingLicenceDetailsResponse
    {
        ...
        /// <summary>
        /// Response code returned by the Dvla autolookup API 
        /// </summary>
        public string ResponseCode { get; set; }
        /// <summary>
        /// Driving licence owner employeeid
        /// </summary>
        public int EmployeeId { get; set; }

        /// <summary>
        /// Gets or sets Driving Licence source.
        /// </summary>
        public string Source { get; set; }

        /// <summary>
        /// Gets or sets the licence type of the licence which is being inserted through automation.
        /// </summary>
        public string LicenceType { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether the review status is passed.
        /// </summary>
        public bool ReviewStatusIfItsAManualLicence { get; set; }
        ...
        /// <param name="employeeId">Driving licence owner</param>
        /// <param name="responseCode">Response Code returned by dvla auto lookup api</param>
