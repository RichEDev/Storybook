namespace SpendManagementLibrary.DVLA
{
    ...
    public class EntitlementDetails
    {
        ...
        /// </summary>
        /// <param name="code">Code of entitlement category</param>
        /// <param name="type">Indicates if entitlement is Provisional (P), Full (F), or Unclaimed Test Pass (U)</param>
        /// <param name="validFrom">Date the entitlement is valid from</param>
        /// <param name="validTo">Date the entitlement is valid to</param>
