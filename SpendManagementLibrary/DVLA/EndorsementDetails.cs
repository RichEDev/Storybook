namespace SpendManagementLibrary.DVLA
{
    ...
    public class EndorsementDetails
    {
        ...
        /// <summary>
        /// Endorsement constractor with endorsement details for driving licence
        /// </summary>
        /// <param name="code"> Identifies the endorsement code </param>
        /// <param name="convictionDate"> The date of conviction</param>
        /// <param name="isDisqualified"> True or False based upon if the endorsement resulted in the driver being disqualified from driving</param>
        /// <param name="disqualificationEndDate">The end date of the disqualification period</param>
        /// <param name="numberOfPoints"> Number of penalty points present on the endorsement</param>
        /// <param name="offenceDate">The date of the offence</param>
