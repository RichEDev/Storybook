/// <summary>
/// Contains all elements within SpendManagement, Use only the string value please
/// </summary>
public enum SpendManagementElement
{
    None = -1,
    AccessRoles = 6,
    Advances = 7,
    ...
    GreenLightMenu = 177,
    ClaimViewer = 178,
    Addresses = 179, // = 38 - this should replace locations eventually
    Organisations = 180,
    Api = 181,
    SupportTickets = 182,
