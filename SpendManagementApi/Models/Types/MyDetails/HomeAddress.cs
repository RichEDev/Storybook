...
namespace SpendManagementApi.Models.Types.MyDetails
{
    ...
    /// <summary>
    /// Represents an Employee home address
    /// </summary>
    public class HomeAddress : IApiFrontForDbObject<cEmployeeHomeAddress, HomeAddress>
    {
        /// <summary>
        ...
        public HomeAddress From(cEmployeeHomeAddress dbType, IActionContext actionContext)
        {
        ...
        cEmployeeHomeAddress IApiFrontForDbObject<cEmployeeHomeAddress, HomeAddress>.To(IActionContext actionContext)
        {
            //TODO: Not needed
