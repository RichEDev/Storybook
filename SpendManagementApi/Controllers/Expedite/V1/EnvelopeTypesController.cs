namespace SpendManagementApi.Controllers.Expedite.V1
{
    ...
    [Version(1)]
    [ExpediteOnly, ApiExplorerSettings(IgnoreApi = true)]
    public class EnvelopeTypesV1Controller : BaseApiController<EnvelopeType>
    {
        ...
        public EnvelopeTypesV1Controller(IRepository<EnvelopeType> envelopeRepository)
        ...
        /// </summary>
        public EnvelopeTypesV1Controller()
        {
        }
