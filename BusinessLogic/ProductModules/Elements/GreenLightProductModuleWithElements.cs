namespace BusinessLogic.ProductModules
{
    ...
    [Serializable]
    public class GreenLightProductModuleWithElements : ProductModuleWithElements
    {
        /// <summary>
        ...
        public GreenLightProductModuleWithElements(int id, string name, string description, string brandName, string brandNameHtml, IList<IElement> elements)
