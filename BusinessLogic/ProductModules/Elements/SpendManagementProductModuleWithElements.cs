namespace BusinessLogic.ProductModules
{
    ...
    [Serializable]
    public class SpendManagementProductModuleWithElements : ProductModuleWithElements
    {
        /// <summary>
        ...
        public SpendManagementProductModuleWithElements(int id, string name, string description, string brandName, string brandNameHtml, IList<IElement> elements)
