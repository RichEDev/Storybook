namespace BusinessLogic.ProductModules
{
    ...
    [Serializable]
    public class CorporateDilligenceProductModuleWithElements : ProductModuleWithElements
    {
        /// <summary>
        /// Create a new instance of <see cref="CorporateDilligenceProductModule"/>
        /// </summary>
        ...
        public CorporateDilligenceProductModuleWithElements(int id, string name, string description, string brandName, string brandNameHtml, IList<IElement> elements)
