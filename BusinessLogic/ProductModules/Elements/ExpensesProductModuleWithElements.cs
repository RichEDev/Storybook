namespace BusinessLogic.ProductModules
{
    ...
    [Serializable]
    public class ExpensesProductModuleWithElements : ProductModuleWithElements
    {
        /// <summary>
        /// Create a new instance of <see cref="ExpensesProductModule"/>
        /// </summary>
        ...
        public ExpensesProductModuleWithElements(int id, string name, string description, string brandName, string brandNameHtml, IList<IElement> elements)
