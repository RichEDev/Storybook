namespace BusinessLogic.ProductModules
{
    ...
    [Serializable]
    public class FrameworkProductModuleWithElements : ProductModuleWithElements
    {
        /// <summary>
        ...
        public FrameworkProductModuleWithElements(int id, string name, string description, string brandName, string brandNameHtml, IList<IElement> elements)
