namespace BusinessLogic.ProductModules
{
    ...
    [Serializable]
    public class EsrProductModuleWithElements : ProductModuleWithElements
    {
        /// <summary>
        ...
        public EsrProductModuleWithElements(int id, string name, string description, string brandName, string brandNameHtml, IList<IElement> elements)
