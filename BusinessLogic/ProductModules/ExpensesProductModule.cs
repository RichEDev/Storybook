...
{
    public class ExpensesProductModule : ProductModule
    {
        /// <summary>
        ...
        public ExpensesProductModule(int id, string name, string description, string brandName ) : base(id, name, description, brandName)
        {
