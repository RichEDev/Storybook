namespace BusinessLogic.Tables.Type
{
    ...
    public class CustomEntityTable : MetabaseTable, ICustomTable
    {
        /// <summary>
        /// Creates a new instance of the <see cref="CustomEntityTable"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the <see cref="CustomEntityTable"/> Account ID.
        /// </summary>
