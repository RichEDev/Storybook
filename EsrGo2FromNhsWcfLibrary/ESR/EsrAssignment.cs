namespace EsrGo2FromNhsWcfLibrary.ESR
{
    ...
    public class EsrAssignment : DataClassBase
    {
        ...
        /// <summary>
        /// The ESR Assignment Id of the department manager
        /// </summary>
        [DataMember]
        [DataClass(ColumnRef = 18, FieldId = "081837AA-A9EF-4316-BF97-15507B7FEBFE")]
        public long? DepartmentManagerAssignmentId;

        /// <summary>
        /// The ESR Assignment Id of the department manager (preserved copy)
        /// </summary>
        [DataMember]
        public long? SafeDepartmentManagerAssignmentId { get; set; }
