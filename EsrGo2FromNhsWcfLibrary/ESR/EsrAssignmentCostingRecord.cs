namespace EsrGo2FromNhsWcfLibrary.ESR
{
    ...
    public class EsrAssignmentCostingRecord : EsrAssignmentCostings
    {
        ...
        public static EsrAssignmentCostingRecord ParseEsrAssignmentCostingRecord(string recordLine)
        {
            ...
            long esrAssignmentCostingAllocationId;
            ...
            switch (rec[(int)AssignmentCostingRecordColumnsRef.RecordType].ToUpper())
            {
                case EsrRecordTypes.EsrAssignmentCostingUpdateRecordType:
                    ...
                    DateTime tmpDate;
                    if (EsrDateHelpers.TryParseExact(rec[(int)AssignmentCostingRecordColumnsRef.EffectiveStartDate], "yyyyMMdd", out tmpDate))
                    {
                        effectStartDate = tmpDate;
                    }

                    if (EsrDateHelpers.TryParseExact(rec[(int)AssignmentCostingRecordColumnsRef.EffectiveEndDate], "yyyyMMdd", out tmpDate))
                    {
                    ...
                    if (EsrDateHelpers.TryParseExact(rec[(int)AssignmentCostingRecordColumnsRef.LastUpdateDate], "yyyyMMdd HHmmss", out tmpDate))
                    {
                ...
                case EsrRecordTypes.EsrAssignmentCostingDeleteRecordType:
                    ...
                    recordAction = Base.Action.Delete;
