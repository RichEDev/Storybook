namespace EsrGo2FromNhsWcfLibrary.Base
{
    ...
    public class Log
    {
        ...
        /// The <see cref="bool"/>.
        /// </returns>
        public bool Write(string metaBase, string nhsVpd, int accountid, LogRecord.LogItemTypes logItemType, LogRecord.TransferTypes transferType, int logId, string fileName, LogRecord.LogReasonType logReasonType, string message,  string source)
        {
        ...
        /// The <see cref="bool"/>.
        /// </returns>
        public bool WriteDebug(string metaBase, string nhsVpd, int accountid, LogRecord.LogItemTypes logItemType, LogRecord.TransferTypes transferType, int logId, string fileName, LogRecord.LogReasonType logReason, string message, string source)
        {
        ...
        /// The <see cref="bool"/>.
        /// </returns>
        public bool WriteExtra(string metaBase, string nhsVpd, int accountid, LogRecord.LogItemTypes logItemType, LogRecord.TransferTypes transferType, int logId, string fileName, LogRecord.LogReasonType logReason, string message, string source)
        {
