    ...
    public class DataClassBase
    {
        ...
        public string ReadStoredProcedure
        {
            get
            {
                ...
                return readClassName.EndsWith("ss") 
                    ? string.Format("dbo.APIget{0}es", readClassName) 
                    : string.Format(readClassName.EndsWith("s") ? "dbo.APIget{0}" : "dbo.APIget{0}s", readClassName);
            }
        }
        ...
        /// </summary>
        [ScriptIgnore]
        public string ReadBatchStoredProcedure
        {
            get
            {
                var readClassName = this.ClassName();
                return readClassName.EndsWith("ss")
                    ? string.Format("dbo.APIBatchGet{0}es", readClassName)
                    : string.Format(readClassName.EndsWith("s") ? "dbo.APIBatchGet{0}" : "dbo.APIBatchGet{0}s", readClassName);
            }
        }
        ...
        /// </summary>
        [ScriptIgnore]
        public string SaveStoredProcedureBatch
        {
            get
            {
                return string.Format("dbo.ApiBatchSave{0}", this.ClassName());
            }
        }
        ...
        /// </summary>
        [ScriptIgnore]
        public string ReadByEsrIdStoredProcedure
        {
            get
            {
                var readClassName = this.ClassName();
                return string.Format(readClassName.EndsWith("s") ? "dbo.APIget{0}ByEsrId" : "dbo.APIget{0}sByEsrId", readClassName);
            }
        }

        /// <summary>
        /// Gets the read by assignment id stored procedure.
        /// </summary>
        [ScriptIgnore]
        public string ReadByAssignmentIdStoredProcedure
        {
            get
            {
                var readClassName = this.ClassName();
                return string.Format(readClassName.EndsWith("s") ? "dbo.APIget{0}ByAssignmentId" : "dbo.APIget{0}sByAssignmentId", readClassName);
            }
        }
        ...
        public long KeyValue
        {
            ...
            set
            {
                this.KeyField.SetValue(this, Convert.ChangeType(value, this.KeyField.FieldType));
            }
        }
        ...
        public FieldInfo[] ClassFields()
        {
            ...
            MemoryCache.Default.Add(this.FieldKey(), fields, new CacheItemPolicy { SlidingExpiration = TimeSpan.FromMinutes(60) });
            return fields;
        }
        ...
        public PropertyInfo[] ClassProperties()
        {
            ...
            MemoryCache.Default.Add(this.PropertyKey(), properties, new CacheItemPolicy { SlidingExpiration = TimeSpan.FromMinutes(60) });
            return properties;
        }
        ...
        /// The account id.
        /// </param>
        /// <param name="userdefined">user defined fields</param>
